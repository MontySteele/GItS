...
| The six the summon sweep missed | `friendly_visit`, `study_buddy`, `fantastic_voyage`, `passion_overload`, `shattering_pressure`, `frozen` | shortlist/auto | `friendly_visit`, `study_buddy` are two of the four **AS2-E2 "weak marks"** — new r2/r3 offered, incumbent r1 kept (`review/active/art-runs-2026-08-08.md:59-73`); the pick sits in QUEUE **Art debt** / `S4-G17` |
...
**Review state: OPEN, awaiting one live look.** `review/active/eb67-kokomi-icons-2026-08-26.md`
...
`review/active/eb67-kokomi-icons-2026-08-26.md` §2 (a table naming each rank-1
...
`review/active/{art-runs-2026-08-08,eb67-kokomi-icons-2026-08-26}.md`;
