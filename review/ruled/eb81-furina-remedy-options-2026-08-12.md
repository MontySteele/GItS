...
`review/records/sitting-reads-2026-08-08.md` §1. Same recipe, same seed, 3000
runs per arm.
...
| The standing read and its stamp | `review/records/sitting-reads-2026-08-08.md` §1 |
| Stamp law; one variable per window; a scorer change is a bump | `docs/current/EXPERIMENTS.md` |
| `D14` pinned; the six-step order, verbatim | `review/records/payoff-reach-reregistration.md`; R121 |
