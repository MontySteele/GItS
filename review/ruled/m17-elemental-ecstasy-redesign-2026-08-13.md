...
> (`review/records/eb17p-registration-draft-2026-08-08.md`) and its results file
> (`review/records/eb17p-results-2026-08-10.txt`) are **not edited** by this
...
(`review/records/payoff-reach-reregistration.md` §6.2). Reaction is the plan
...
**`review/records/m17-sweep-reregistration-p7-2026-08-13.md`**: the same five
