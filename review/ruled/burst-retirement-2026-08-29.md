...
(`review/ruled/kokomi-kurage-memory-2026-08-29.md:645–649`):
...
`review/ruled/sitting-2026-08-30.md`**: re-author the grant as a declared
...
`review/ruled/sitting-2026-08-30.md` (§6 item 1).
...
Her fold is being drafted in `review/ruled/furina-reframe-2026-08-29.md` on
...
`review/ruled/furina-reframe-2026-08-29.md` is not on `main`. The pointer is
recorded as given.
...
packet's smoke (`review/ruled/klee-sparks-2026-08-29.md:863–873`) measured,
...
Everything ships
behind **`SPARK_ALT_COST_ENABLED`** (`review/ruled/klee-sparks-2026-08-29.md:453,
...
(`review/ruled/kokomi-kurage-memory-2026-08-29.md:1796–1798`) are unused and
...
**Merge it with the HP re-baseline.** `review/records/roster-hp-scalers-2026-08-29.md`
