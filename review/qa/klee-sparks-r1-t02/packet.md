# Staged turn `klee-sparks-r1-t02`
...
- Block 0
- Energy 3
- Spark 1 — A resource. Cards that print a Spark price spend it.
...
- The Spark bank is written to 1 through SPARK_POWER, which is how the live game holds Sparks.
