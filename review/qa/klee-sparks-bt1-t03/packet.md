# Staged turn `klee-sparks-bt1-t03`
...
- The Spark bank is written to 2 through SPARK_POWER. Nothing in the hand can raise it this turn, so 2 is the bank for the whole turn.
