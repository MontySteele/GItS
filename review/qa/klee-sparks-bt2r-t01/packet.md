# Staged turn `klee-sparks-bt2r-t01`
...
- Relic — Fishing Rod: Every 3 normal combats, Upgrade a random card in your Deck.
...
1. If you spend 3 Sparks on Bag of Tricks this turn, what number will your Spark bank show IMMEDIATELY after that card resolves?
2. If you then play Kaboom! at the same enemy, what will your Spark bank show immediately after Kaboom! resolves?
3. What will your Spark bank show at the very end of this turn, on the line you are about to play?
...
- The Spark bank is written to 3 through SPARK_POWER, which is how the live game holds Sparks. 3 is the price of the mode and the price of the other Spark-priced card in hand, exactly.
- The run carries Klee's starting relic and no other. It is printed on the page, which is a change from the first version of this round: that relic pays 1 Spark for every Bomb that detonates, and a reader who cannot see it cannot do the turn's arithmetic.
