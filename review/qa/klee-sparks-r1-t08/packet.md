# Staged turn `klee-sparks-r1-t08`
...
- Cannot be played right now: BlockedByCardLogic
- (card text read from: bridge)
...
- The Spark bank is EMPTY, and the Spark power is absent rather than present at zero.
