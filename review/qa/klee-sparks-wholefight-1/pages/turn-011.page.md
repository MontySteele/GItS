...
- Block 0
- Energy 3/3
- Burst: 10 — the game's data feed carries this meter's amount only: no maximum, and no rule for how it is spent
- Spark 1 (buff) — A resource. Cards that print a Spark price spend it.
- Piles: 1 in the draw pile, 10 discarded, 0 exhausted
...
- **Tinder Toss** — cost 0, attack
    Spend 1 Spark. Deal 4 damage to ALL enemies. Applies Pyro.
    *Applies Pyro* — If the target has no aura, this applies Pyro for 2 turns. A different aura is consumed to trigger a Reaction instead.
...
- **Toadpole** — HP 9/24
    ...
    Pyro Aura 1 (buff) — Pyro clings to this enemy for 1 more turn. A hit of a different element consumes the aura and triggers an Elemental Reaction; a Pyro hit refreshes its duration.
