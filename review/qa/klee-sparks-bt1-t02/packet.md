# Staged turn `klee-sparks-bt1-t02`
...
- The Spark bank is written to 3 through SPARK_POWER, which is how the live game holds Sparks. 3 is BOTH candidates' price exactly, so the bank buys one of them and not both.
