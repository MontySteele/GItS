# Staged turn `klee-sparks-r2-t03`
...
- No Bomb is on the field. Nothing in this file places one and nothing in the hand places one, so no detonation can occur on this turn.
