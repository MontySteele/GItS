# Staged turn `klee-sparks-bt1-t04`
...
- The Spark bank is written to 2 through SPARK_POWER. Powder Pop is the only card in hand that can raise it, and it raises it by exactly 1.
