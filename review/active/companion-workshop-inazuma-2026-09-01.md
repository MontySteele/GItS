...
decides whether "Gorou, go" is a loop or a wish.

---

## 1. What is wrong with the 15 rows
...
| Shinobu — Grass Ring of Sanctification | Block 4, 0 cost | Defend |
| Shinobu — Thundergrust | Deal 7, Electro | Electro Strike |
| Thoma — Blazing Barrier | Block 5, Block 2 next turn | Defend and a half |
...
little damage'," is the table. The audit found 60% of the pool grants
Block, the most of any nation. That is why Muster read as "hope you get
some block."

## 2. The nation's shape: Inazuma reads the HP bar
...
to 36%, and every remaining Block line is attached to a verb.
...
1. **The nation shape.** (1) *Inazuma reads the HP bar* [default]. (2) No
   nation shape for Inazuma; author to the Common bar only.
2. **Sanctifying Ring's HP cost on a Universal.** (1) *Yes: "Lose 3 HP" is
   StS grammar and the brick test passes* [default]. (2) No self-damage on
   any Universal; the ring costs 2 energy instead.
3. **New characters.** (1) *All nine enter; 9 new illustrations* [default].
   (2) Kazuha, Yae, Ayato and Mizuki only, the four with a Kokomi tie; the
   rest wait.
