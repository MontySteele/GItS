...
> **This table supersedes `review/active/sitting-reads-2026-08-24.md` as the
...
| **before** | `review/active/sitting-reads-2026-08-24.md` §§1–3, `D15` columns, HEAD `499186b` |
...
- **Both columns of `review/active/sitting-reads-2026-08-24.md`.** Its `D14`
  ...
  going forward.
- **Every column of `review/active/sitting-reads-2026-08-13.md`** (`C10`,
  `D14`) and **`review/active/sitting-reads-2026-08-08.md`** (`RT9/D14/P6/C8`).
