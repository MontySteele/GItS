...
- **Fanfare cap = `FANFARE_CAP_FRACTION` × maxHP** (0.5;
  ...
  *Note:* `review/active/furina-e4-2026-08-29.md` §5 proposes retiring
...
- **The standing twelve-arm baseline**,
  `review/active/sitting-reads-2026-08-26-c20-d18-p11.md` at `RT12/D18/P11/C20`
...
- **The act-1 clear rates in the richness / sitting reads** —
  `review/active/sitting-reads-2026-08-08.md` (salon 54.33%; priest 42.20%,
...
**Cost of the re-baseline:** `review/active/eb81-furina-remedy-options-2026-08-12.md`
