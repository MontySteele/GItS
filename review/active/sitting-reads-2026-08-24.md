...
> **This table supersedes `review/active/sitting-reads-2026-08-13.md` as the
...
- **Every column of `review/active/sitting-reads-2026-08-13.md`.** Its `RT10`
  ...
  `D14` going forward.
- **`review/active/sitting-reads-2026-08-08.md`**, taken at `RT9/D14/P6/C8` —
...
- **Every number published by the payoff-reach registration**
  (`review/active/payoff-reach-reregistration.md`), a `D14` read. Archive by
