...
2. **All of My Treasures!** — Rare Skill, 1 energy, Exhaust. *Place a Bomb
   ...
   The cook decision is whether to play it on a 12 or let the Bomb reach
   16 first, and the copy then grows on its own schedule (rule 9, each
   Bomb grows separately).
