...
> `review/records/m17-sweep-results-2026-08-26.txt`, and the grade is **§12**,
...
>
> **R101b holds absolutely.** `review/records/eb17p-registration-draft-2026-08-08.md`
> and `review/records/eb17p-results-2026-08-10.txt` are **untouched** by this
...
**Parent.** `EB-17p`, `review/records/eb17p-registration-draft-2026-08-08.md`,
...
`C15`'s own pre-registration (`review/records/eb118-w1-preregistration-2026-08-24.md`
...
`review/ruled/m17-elemental-ecstasy-redesign-2026-08-13.md` §6, and the choice
...
6. Run the sweep at the pinned stamp. Report only; read nothing into it.
   ...
   **DONE 2026-08-26** — S1 checked first and silent, 2 min 15 s, raw output at
   `review/records/m17-sweep-results-2026-08-26.txt`.
...
```
PYTHONPATH=. python3 -m tier05.exp_eb17p_forced_copy --runs 2400 --jobs 0 | tee review/records/m17-sweep-results-2026-08-26.txt
```
