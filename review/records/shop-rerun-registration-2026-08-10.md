...
> `review/records/shop-rerun-results-2026-08-26.txt`; nothing above §8 was
...
7. **`RUNTEMPLATE_VERSION` 11** (the coordinated 2026-08-13 window,
   ...
   **Unlike item 6, this is not named for completeness.** Item 6 was proved
   ...
   this bump was `review/records/sitting-reads-2026-08-13.md`, **and it is no
...
**`review/records/sitting-reads-2026-08-25-c19-d17-p10.md`** — twelve arms at
...
supersedes `review/records/sitting-reads-2026-08-24.md`, which item 11 and the
`M14` row used to name, and `review/records/sitting-reads-2026-08-24-c13-d16.md`
...
```
registration  review/records/shop-rerun-registration-2026-08-10.md §2, §4
run date      <date>
...
**The read:** `review/records/shop-rerun-results-2026-08-26.txt` — the
...
this shape (`review/records/m17-sweep-reregistration-p7-2026-08-13.md`,
`review/records/eb17p-registration-draft-2026-08-08.md`,
`review/records/charge-reads-per-turn-registration-2026-08-13.md`), and both §7
