...
> **This table supersedes `review/records/sitting-reads-2026-08-24-c13-d16.md`
...
| **before** | `review/records/sitting-reads-2026-08-24-c13-d16.md` §§1–3 (`C13/D16` columns, ten arms) and §8.3 (the two `real_*` floors, same cell, `main` = `4fee4a6`) |
...
- **Every column of `review/records/sitting-reads-2026-08-24-c13-d16.md`**,
  ...
  them going forward.
- **Every column of `review/records/sitting-reads-2026-08-24.md`** (`C11`,
  `D14`/`D15`), **`review/records/sitting-reads-2026-08-13.md`** (`C10`, `D14`)
  and **`review/records/sitting-reads-2026-08-08.md`** (`RT9/D14/P6/C8`).
