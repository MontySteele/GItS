...
| backlog §2 "Understudy P1.5 — the bridge fork: NEXT" | **BUILT 2026-08-05**; log `docs/sprint-understudy-p15-log-2026-08-05.md`. Its four non-closures are `EB-14`/`EB-15` above and queue row 10.5 |
