...
right. The six `bg_00` rows answer to a second rule as well and spend their
...
there is no spare height left. The rest-site and map plates have no creature
standing on them and keep `top` / `x0.42` unchanged.
