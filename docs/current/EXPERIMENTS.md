...
Standing measurement law, plus pointers to the active registrations. A
...
## Measurement authority (moved out of LAW, 2026-09-01)

Three blocks of `LAW.md` were measurement law rather than design or
engineering law, so they live here. They are moved verbatim, with their old
line ranges named. LAW keeps a one-line pointer at each site.

### What a measured number may be used for (was LAW lines 272 to 296)
...
### A material card-sheet edit is a world change (was LAW lines 249 to 269)
...
### The distinctness gate (was LAW lines 238 to 240)
...
- **`EB-118` card-connectivity instrument** — static pre-registration at
  ...
  `review/records/eb118-connectivity-baseline-2026-08-24.txt`, at `a2e389f` and
...
- **The regret margins (`M13`)** — **DRAFT, unrun**, §7's predictions blank.
  **Instrument:** `tools/regret_distribution.py`, a read-only pass over
  ...
  work is BACKLOG `M13` →
  `review/records/regret-margin-registration-2026-08-12.md`.
...
- **The Furina reframe slate — the orb-board Salon read on staged boards** —
  **COUNTERSIGNED (R233, 2026-08-30), UNRUN.** Registered here 2026-08-30 by
  ...
  `review/ruled/furina-reframe-2026-08-29.md` §6.3.
- **`X9READ-S2` — Kokomi's charge reads per turn, re-read on the corrected
  ...
  **Slate:** seven slots at packet §10.4, `X1b`–`X7b`, every threshold a
  ...
  `review/records/charge-reads-per-turn-registration-2026-08-13.md` §10.
...
the packet and its raw results move to `review/records/` and are never edited
after that (R101b), and the long active-entry narrative goes to the commit
message that moved it.
