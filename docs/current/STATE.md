...
**`RT12 / D16 / P9 / C18`**, read live via `tier05/cells.py`, with
...
- **`EB-118` richness pass — Phase 2 is COMPLETE; Phase 3 Windows 1 and 2 are
  LANDED and W3 is the live front.** All three Phase-2 windows are closed: the
