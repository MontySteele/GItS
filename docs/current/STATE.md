...
**`MAJOR.AUTO`** with the `+proto` dev mark. **Installed: `0.2.3642+proto`**
(2026-09-17, main after #618, arms `klee,companion,kokomi,furina-stage,teyvat`:
...
- **The Teyvat run frame (R272, 2026-09-14)** — the non-mechanical layer
  ...
  **R273 (2026-09-14)** ruled the nation mapping
  ...
  every enemy dressed as a still, 149 face-slots on 122 plates (`EB-811`,
  149 live rows; per-enemy animation is the next pass), the eight Ancients
