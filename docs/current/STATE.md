...
**`MAJOR.AUTO`** with the `+proto` dev mark. **Installed: `0.2.3632+proto`**
(2026-09-17, main after #614, arms `klee,companion,kokomi,furina-stage,teyvat`:
...
- **The Teyvat run frame (R272, 2026-09-14)** — the non-mechanical layer
  ...
  **R273 (2026-09-14)** ruled the nation mapping
  ...
  77 dressed enemy bodies with Teyvat names (`EB-811`, 97 live rows; Liyue keyed to
  the Underdocks roster), real act plates on all six dressings (30, `media/ACT.tsv`)
