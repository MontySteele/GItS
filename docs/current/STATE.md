...
**`MAJOR.AUTO`** with the `+proto` dev mark. **Installed: `0.2.3333+proto`**
(2026-09-15, main after #522, arms `klee,companion,kokomi,furina-stage,teyvat`:
...
- **The Teyvat run frame (R272, 2026-09-14)** — the non-mechanical layer
  ...
  **R273 (2026-09-14)** ruled the nation mapping
  ...
  116 dressed events (act 1: 38, act 2: 48, act 3: 30, generated by
  `tools/gen_teyvat_events.py` from the faces under
  `dossiers/content/event-faces/`, three events parked for prose), 38 death
  lines, one still-portrait enemy, placeholder art per dressing
  (`operations/act-assets.md`), music as a local skeleton
  (`operations/media.md`). Proven in the running game: act 1 both faces,
  combat backgrounds, rest site, five dressed events; acts 2 and 3 are
  unproven (no act-skip op; `review/records/teyvat-proofs-4-2026-09-15.md`).
  Open costs: `EB-767`, and the two proofs-4 rows. Kickoff
