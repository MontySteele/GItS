...
| `S4-G14` | Kokomi protocol playtest (Q1–Q7 + three priority checks; Answers blank) | `docs/kokomi-playtest-protocol.md` | OPEN — blocked on `S4-G6`, and (per backlog §4) on the N1 attribution pass. **Re-anchor STAGED with `S4-G6`: see `Q8`** |
