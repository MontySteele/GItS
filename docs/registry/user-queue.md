...
| ~~Q17~~ **Sign the Class-P charter §5?** | *"Oops - yes, charter is AUTHORIZEd"* (R119) | The §5 R-draft is law; the purge swarm ran (P-ledger batch 1, seven rows + doubt set) |
