...
| **Decisions-status sidecar red-pen** *(minted 2026-08-06 by Track R-D, Clear the Stage / R119)* | **Every ruling now has a status row, and almost every status honestly says "nobody has judged this yet."** The ledger split (R39–R99 → `tier0/DECISIONS-archive-R39-R99.md`) came with a sidecar, `tier0/decisions-status.tsv`: one row per ruling R39–R120. Five statuses were derived mechanically from explicit strikes/banners (R54/R55/R56/R88/R102, evidence quoted in the file); the other 77 are `UNREVIEWED`, because "still operative vs superseded" is a judgment the plan of record assigns to one [USER] red-pen pass — per-ruling, vocabulary `OPERATIVE / SUPERSEDED-BY:R<n> / DISCHARGED / HISTORICAL`. Until the pass, the generated current-law digest in `tier0/DECISIONS.md` marks those rows unreviewed rather than pretending | A digest that actually states current law; every future "is R<n> still binding?" lookup | `tier0/decisions-status.tsv` (header states the discipline); `review/stage-clear/refactor-plan.md` §R-D; `tools/gen_decisions_digest.py` |
