...
//
//     Sheet entry: id=remote_detonator rarity=uncommon cost=1
...
public sealed class RemoteDetonator : CustomCardModel
{
    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("remote_detonator");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Remote Detonator"),
        ("description", "Detonate ALL [gold]Bombs[/gold]. Detonations deal {Bonus:diff()} more damage."),
    };
    ...
    {
        await BombPower.DetonateAll(choiceContext, CombatState!.HittableEnemies.ToList(), DynamicVars["Bonus"].IntValue);
    }
