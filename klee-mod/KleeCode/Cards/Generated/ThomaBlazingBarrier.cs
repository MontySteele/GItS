...
//
//     Sheet entry: id=thoma_blazing_barrier rarity=common cost=1
...
public sealed class ThomaBlazingBarrier : CustomCardModel, ICompanionCard
{
    ...
    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("thoma_blazing_barrier");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Thoma — Blazing Barrier"),
        ("description", "Gain {CalculatedBlock:diff()} [gold]Block[/gold]. At the start of your next turn, gain 2 [gold]Block[/gold]."),
    };
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        await PowerCmd.Apply<BlockNextTurnPower>(choiceContext, Owner.Creature, (int)SpotlightSystem.PrintedBlock(this, 2), applier: Owner.Creature, cardSource: this);
    }
