...
//
//     Sheet entry: id=spirited_away rarity=uncommon cost=2
...
public sealed class SpiritedAway : CustomCardModel
{
    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("spirited_away");
