...
//
//     Sheet entry: id=spark_knight_style rarity=uncommon cost=1
...
public sealed class SparkKnightStyle : CustomCardModel
{
    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("spark_knight_style");
    ...
    {
        await PowerCmd.Apply<ZeroCostAttacksUpPower>(choiceContext, Owner.Creature, DynamicVars["PowerAmount"].IntValue, applier: Owner.Creature, cardSource: this);
    }
