...
//
//     Sheet entry: id=neuvillette_ancient_sea_authority rarity=rare cost=1
...
public sealed class NeuvilletteAncientSeaAuthority : CustomCardModel, ICompanionCard
{
    ...
    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("neuvillette_ancient_sea_authority");
    ...
    public NeuvilletteAncientSeaAuthority()
    ...
    {
        await PowerCmd.Apply<AncientSeaAuthorityPower>(choiceContext, Owner.Creature, 1, applier: Owner.Creature, cardSource: this);
    }
