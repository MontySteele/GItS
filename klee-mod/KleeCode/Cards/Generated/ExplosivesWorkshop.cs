...
//
//     Sheet entry: id=explosives_workshop rarity=uncommon cost=1
...
public sealed class ExplosivesWorkshop : CustomCardModel
{
    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("explosives_workshop");
