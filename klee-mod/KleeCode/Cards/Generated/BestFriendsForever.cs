...
//
//     Sheet entry: id=best_friends_forever rarity=rare cost=1
...
public sealed class BestFriendsForever : CustomCardModel
{
    public override IEnumerable<CardKeyword> CanonicalKeywords =>
        new[] { CardKeyword.Exhaust };

    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("best_friends_forever");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Best Friends Forever"),
        ("description", "Add a copy of every [gold]Companion[/gold] card played this combat to your hand. They cost 0."),
    };
