...
//
//     Sheet entry: id=raiden_musou_no_hitotachi rarity=rare cost=3
...
public sealed class RaidenMusouNoHitotachi : CustomCardModel, IElementalCard, ICompanionCard
{
    ...
    public override IEnumerable<CardKeyword> CanonicalKeywords =>
        new[] { CardKeyword.Exhaust, KleeKeywords.AppliesElectro };

    protected override IEnumerable<IHoverTip> ExtraHoverTips =>
        KleeCardTooltips.ForCard(base.ExtraHoverTips, this, Element.Electro, includesBombRules: false);

    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("raiden_musou_no_hitotachi");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Raiden Shogun — Musou no Hitotachi"),
        ("description", "Deal {CalculatedDamage:diff()} damage. Apply 2 [gold]Vulnerable[/gold]."),
    };
