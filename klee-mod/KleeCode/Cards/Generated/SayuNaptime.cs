...
//
//     Sheet entry: id=sayu_naptime rarity=uncommon cost=0
...
public sealed class SayuNaptime : CustomCardModel, ICompanionCard
{
    ...
    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("sayu_naptime");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Sayu — Naptime"),
        ("description", "Gain {CalculatedBlock:diff()} [gold]Block[/gold]. Draw {Cards:diff()} card{Cards:plural:|s}."),
    };
