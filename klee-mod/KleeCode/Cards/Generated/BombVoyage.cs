...
//
//     Sheet entry: id=bomb_voyage rarity=common cost=2
...
public sealed class BombVoyage : CustomCardModel, ISkillTagCard
{
    ...
    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("bomb_voyage");
    ...
    public BombVoyage()
        : base(2, CardType.Skill, CardRarity.Common, TargetType.AnyEnemy, autoAdd: false)
    {
    }
