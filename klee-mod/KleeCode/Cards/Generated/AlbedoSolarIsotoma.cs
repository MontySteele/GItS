...
//
//     Sheet entry: id=albedo_solar_isotoma rarity=rare cost=1
...
public sealed class AlbedoSolarIsotoma : CustomCardModel, ICompanionCard
{
    ...
    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("albedo_solar_isotoma");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Albedo — Solar Isotoma"),
        ("description", "For {PowerAmount:diff()} turns: your Attacks against enemies holding an elemental aura grant 3 [gold]Block[/gold] per hit."),
    };
    ...
    {
        await PowerCmd.Apply<SolarIsotomaPower>(choiceContext, Owner.Creature, DynamicVars["PowerAmount"].IntValue, applier: Owner.Creature, cardSource: this);
    }
