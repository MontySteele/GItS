...
//
//     Sheet entry: id=arlecchino_masque_red_death rarity=rare cost=1
...
public sealed class ArlecchinoMasqueRedDeath : CustomCardModel, ICompanionCard
{
    ...
    public ArlecchinoMasqueRedDeath()
    ...
    {
        await PowerCmd.Apply<MasqueRedDeathPower>(choiceContext, Owner.Creature, DynamicVars["PowerAmount"].IntValue, applier: Owner.Creature, cardSource: this);
    }
