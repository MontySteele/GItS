...
//
//     Sheet entry: id=all_my_treasures rarity=rare cost=3
...
public sealed class AllMyTreasures : CustomCardModel, ISkillTagCard
{
    ...
    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("all_my_treasures");
    ...
    public AllMyTreasures()
        : base(3, CardType.Skill, CardRarity.Rare, TargetType.AllEnemies, autoAdd: false)
    {
    }
