...
public static class CompanionRoster
{
    ...
    public static IReadOnlyList<CardModel> All => _all ??= new List<CardModel>
    {
        ...
        ModelDb.Card<CharlotteFreezingPoint>(),
        ModelDb.Card<CharlotteSnappySilhouette>(),
        ...
        ModelDb.Card<FreminetPressurizedFloe>(),
        ModelDb.Card<FreminetShatteringPressure>(),
        ModelDb.Card<GorouHeartOfTheClan>(),
        ModelDb.Card<GorouInuzakaCharge>(),
        ModelDb.Card<GorouWarBanner>(),
        ModelDb.Card<IttoSuperlativeSuperstrength>(),
        ...
        ModelDb.Card<SaraCrowfeatherCover>(),
        ModelDb.Card<SaraTenguStormcall>(),
        ModelDb.Card<SayuDarumaGift>(),
        ModelDb.Card<SayuNaptime>(),
        ModelDb.Card<SayuYoohooWindwheel>(),
