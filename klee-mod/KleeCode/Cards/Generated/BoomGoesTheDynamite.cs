...
//
//     Sheet entry: id=boom_goes_the_dynamite rarity=common cost=2
...
public sealed class BoomGoesTheDynamite : CustomCardModel, IElementalCard
{
    ...
    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("boom_goes_the_dynamite");
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        var repeatTimes = (ReactionEffects.TotalResolved > reactionsAtStart) ? 1 : 0;
