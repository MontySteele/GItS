...
//
//     Sheet entry: id=combustion_study rarity=common cost=1
...
public sealed class CombustionStudy : CustomCardModel, ISkillTagCard
{
    public override IEnumerable<CardKeyword> CanonicalKeywords =>
        new[] { KleeKeywords.ElementalSkill };

    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("combustion_study");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Combustion Study"),
        ("description", "Gain {BurstEnergy:diff()} [gold]Burst Energy[/gold]. Draw {Cards:diff()} card{Cards:plural:|s}. [gold]Burst[/gold] +5."),
    };

    protected override IEnumerable<DynamicVar> CanonicalVars =>
        new List<DynamicVar>
        {
            new DynamicVar("BurstEnergy", 10m),
            new CardsVar(1)
        };
    ...
    {
        DynamicVars["BurstEnergy"].UpgradeValueBy(5m);
    }
}
