...
//
//     Sheet entry: id=hold_the_line rarity=uncommon cost=1
...
public sealed class HoldTheLine : CustomCardModel
{
    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("hold_the_line");
