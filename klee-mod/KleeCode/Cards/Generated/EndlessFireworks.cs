...
//
//     Sheet entry: id=endless_fireworks rarity=uncommon cost=1
...
public sealed class EndlessFireworks : CustomCardModel
{
    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("endless_fireworks");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Endless Fireworks"),
        ("description", "At the start of your turn, gain 1 [gold]Spark[/gold]."),
    };
    ...
    {
        await PowerCmd.Apply<SparkPerTurnPower>(choiceContext, Owner.Creature, 1, applier: Owner.Creature, cardSource: this);
    }
