...
//
//     Sheet entry: id=sucrose_gust rarity=uncommon cost=0
...
public sealed class SucroseGust : CustomCardModel, ICompanionCard
{
    ...
    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("sucrose_gust");
