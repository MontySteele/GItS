...
//
//     Sheet entry: id=sucrose_astable rarity=uncommon cost=0
...
public sealed class SucroseAstable : CustomCardModel, ICompanionCard
{
    ...
    protected override IEnumerable<IHoverTip> ExtraHoverTips =>
        KleeCardTooltips.ForBurst(KleeCardTooltips.ForCard(base.ExtraHoverTips, this, Element.Anemo, includesBombRules: false), this);
    ...
    public override List<(string, string)>? Localization => new()
    {
        ...
        ("description", "[gold]Swirl[/gold] an enemy's aura. Gain {BurstEnergy:diff()} [gold]Burst Energy[/gold]."),
    };

    protected override IEnumerable<DynamicVar> CanonicalVars =>
        new List<DynamicVar>
        {
            new DynamicVar("BurstEnergy", 8m)
        };
    ...
    {
        DynamicVars["BurstEnergy"].UpgradeValueBy(4m);
    }
}
