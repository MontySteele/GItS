...
//
//     Sheet entry: id=smoke_and_sparks rarity=uncommon cost=1
...
public sealed class SmokeAndSparks : CustomCardModel
{
    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("smoke_and_sparks");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Smoke and Sparks"),
        ("description", "Spend 2 [gold]Sparks[/gold]. Apply {PowerAmount:diff()} [gold]Vulnerable[/gold]."),
    };
