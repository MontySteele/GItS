...
public sealed class BombsAway : CustomCardModel, ISkillTagCard
{
    ...
    {
        ("title", "Bombs Away!"),
        ("description", "Place 5 [gold]Bombs[/gold], each dealing {BombDamage:diff()} damage. [gold]Burst[/gold] +5."),
    };
    ...
    public BombsAway()
        : base(3, CardType.Skill, CardRarity.Uncommon, TargetType.AnyEnemy, autoAdd: false)
    {
    }
