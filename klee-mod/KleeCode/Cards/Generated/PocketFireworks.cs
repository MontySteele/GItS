...
//
//     Sheet entry: id=pocket_fireworks rarity=common cost=1
...
public sealed class PocketFireworks : CustomCardModel, IElementalCard
{
    /// <summary>Sheet: all Klee attacks apply Pyro (catalyst-grade cadence).</summary>
    public Element Element => Element.Pyro;

    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("pocket_fireworks");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Pocket Fireworks"),
        ("description", "Deal {Damage:diff()} damage to random enemies twice."),
    };
