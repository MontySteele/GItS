...
//
//     Sheet entry: id=spooked rarity=common cost=1
...
public sealed class Spooked : CustomCardModel
{
    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("spooked");
