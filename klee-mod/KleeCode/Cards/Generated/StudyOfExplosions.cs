...
//
//     Sheet entry: id=study_of_explosions rarity=common cost=0
...
public sealed class StudyOfExplosions : CustomCardModel, ISkillTagCard
{
    public override IEnumerable<CardKeyword> CanonicalKeywords =>
        new[] { KleeKeywords.ElementalSkill };

    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("study_of_explosions");
