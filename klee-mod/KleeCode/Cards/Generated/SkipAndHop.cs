...
//
//     Sheet entry: id=skip_and_hop rarity=common cost=0
...
public sealed class SkipAndHop : CustomCardModel
{
    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("skip_and_hop");
