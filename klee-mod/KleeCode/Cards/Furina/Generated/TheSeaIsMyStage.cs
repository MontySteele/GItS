...
public sealed class TheSeaIsMyStage : CustomCardModel, ICharacterCard
{
    ...
    public override List<(string, string)>? Localization => new()
    {
        ...
        ("description", "[gold]Fanfare[/gold] +{FanfareFloor:diff()}, and cannot fall below {FanfareFloor:diff()}."),
    };

    protected override IEnumerable<DynamicVar> CanonicalVars =>
        new List<DynamicVar>
        {
            new DynamicVar("FanfareFloor", 15m)
        };
    ...
    {
        DynamicVars["FanfareFloor"].UpgradeValueBy(5m);
    }
}
