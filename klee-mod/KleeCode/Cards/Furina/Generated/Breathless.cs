...
//
//     Sheet entry: id=breathless rarity=common cost=1
...
public sealed class Breathless : CustomCardModel, ICharacterCard
{
    /// <summary>Roster identity used by character-aware mechanics such as Spotlight.</summary>
    public string CharacterId => "furina";

    public override Texture2D? CustomPortrait => RosterArt.CardPortrait("breathless");
