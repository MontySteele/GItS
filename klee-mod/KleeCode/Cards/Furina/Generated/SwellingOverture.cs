...
//
//     Sheet entry: id=swelling_overture rarity=common cost=1
...
public sealed class SwellingOverture : CustomCardModel, ICharacterCard
{
    /// <summary>Roster identity used by character-aware mechanics such as Spotlight.</summary>
    public string CharacterId => "furina";

    public override Texture2D? CustomPortrait => RosterArt.CardPortrait("swelling_overture");
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        if (FurinaResources.Encore(Owner.Creature) >= 8)
        {
