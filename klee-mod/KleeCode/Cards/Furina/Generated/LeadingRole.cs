...
//
//     Sheet entry: id=leading_role rarity=uncommon cost=1
...
public sealed class LeadingRole : CustomCardModel, ICharacterCard
{
    /// <summary>Roster identity used by character-aware mechanics such as Spotlight.</summary>
    public string CharacterId => "furina";

    public override Texture2D? CustomPortrait => RosterArt.CardPortrait("leading_role");
