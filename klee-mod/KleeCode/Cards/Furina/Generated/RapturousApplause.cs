...
//
//     Sheet entry: id=rapturous_applause rarity=rare cost=1
...
public sealed class RapturousApplause : CustomCardModel, ICharacterCard
{
    ...
    public override List<(string, string)>? Localization => new()
    {
        ...
        ("description", "[gold]Fanfare[/gold] +{FanfareFloor:diff()}, and cannot fall below {FanfareFloor:diff()}. Your Attacks deal {PowerAmount:diff()} additional damage per 10 [gold]Fanfare[/gold]."),
    };
