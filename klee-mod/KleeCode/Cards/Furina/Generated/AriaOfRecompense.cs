...
//
//     Sheet entry: id=aria_of_recompense rarity=basic cost=1
...
public sealed class AriaOfRecompense : CustomCardModel, ICharacterCard
{
    ...
    public override List<(string, string)>? Localization => new()
    {
        ...
        ("description", "Gain {IfUpgraded:show:8|5} [gold]Encore[/gold]. Gain {CalculatedBlock:diff()} [gold]Block[/gold]. Scales with [gold]Fanfare[/gold]."),
    };
