...
public sealed class CourtroomDrama : CustomCardModel, ICharacterCard
{
    ...
    public override List<(string, string)>? Localization => new()
    {
        ...
        ("description", "Your first [gold]Elemental Reaction[/gold] each turn applies {PowerAmount:diff()} [gold]Vulnerable[/gold] and {PowerAmount:diff()} [gold]Weak[/gold] to its target before the hit lands."),
    };
