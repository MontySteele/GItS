...
public sealed class SurintendanteChevalmarin : CustomCardModel, ICharacterCard, ISkillTagCard
{
    ...
    public override List<(string, string)>? Localization => new()
    {
        ...
        ("description", "Add 1 [gold]Salon Member(s)[/gold]. Maximum 3. Replacements perform a final bow and empower this card's later effects. Gain {IfUpgraded:show:5|3} [gold]Encore[/gold]."),
    };
