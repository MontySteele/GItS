...
//
//     Sheet entry: id=grand_salon rarity=uncommon cost=1
...
public sealed class GrandSalon : CustomCardModel, ICharacterCard
{
    /// <summary>Roster identity used by character-aware mechanics such as Spotlight.</summary>
    public string CharacterId => "furina";

    public override Texture2D? CustomPortrait => RosterArt.CardPortrait("grand_salon");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Grand Salon"),
        ("description", "[gold]Salon Members[/gold] deal {PowerAmount:diff()} more damage. Maximum 6."),
    };
