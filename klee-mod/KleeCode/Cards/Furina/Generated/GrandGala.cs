...
public sealed class GrandGala : CustomCardModel, ICharacterCard, ISkillTagCard
{
    ...
    {
        ("title", "Grand Gala"),
        ("description", "Add 2 [gold]Mademoiselle Crabaletta[/gold], 1 [gold]Surintendante Chevalmarin[/gold], 1 [gold]Gentilhomme Usher[/gold] to your [gold]Salon[/gold]. Gain {Encore:diff()} [gold]Encore[/gold]. [gold]Burst[/gold] +5."),
    };
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars =>
        new List<DynamicVar>
        {
            ...
            new CalculatedVar("Encore").WithMultiplier(static (card, _) => SalonMemberPower.ReplacementDelta(card, 4, SalonConstants.ReplacementNumericMultiplier))
        };
