...
public sealed class DeepBreath : CustomCardModel, ICharacterCard, IModalCard
{
    ...
    {
        ("title", "Deep Breath"),
        ("description", "Choose one: Gain 1 [gold]Energy[/gold] and 2 [gold]Encore[/gold] | Spend 3 [gold]Encore[/gold]: draw 3 cards."),
    };
    ...
    public IReadOnlyList<string> ModeLabels =>
        new[] { "Gain 1 [gold]Energy[/gold] and 2 [gold]Encore[/gold]", "Spend 3 [gold]Encore[/gold]: draw 3 cards" };
