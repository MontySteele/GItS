...
//
//     Sheet entry: id=crowd_work rarity=uncommon cost=1
...
public sealed class CrowdWork : CustomCardModel, ICharacterCard
{
    /// <summary>Roster identity used by character-aware mechanics such as Spotlight.</summary>
    public string CharacterId => "furina";

    public override Texture2D? CustomPortrait => RosterArt.CardPortrait("crowd_work");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "The Gallery Stirs"),
        ("description", "The first time you spend [gold]Encore[/gold] each turn, draw {PowerAmount:diff()} card{PowerAmount:plural:|s}."),
    };
