...
public sealed class MademoiselleCrabaletta : CustomCardModel, ICharacterCard, ISkillTagCard
{
    ...
    public override List<(string, string)>? Localization => new()
    {
        ...
        ("description", "Add {PowerAmount:diff()} typed [gold]Salon Member(s)[/gold]. Maximum 3; a full stage bows its OLDEST member out (its unique payoff) and empowers this card's later effects."),
    };
