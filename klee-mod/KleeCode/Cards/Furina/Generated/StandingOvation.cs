...
public sealed class StandingOvation : CustomCardModel, ICharacterCard
{
    ...
    public override List<(string, string)>? Localization => new()
    {
        ...
        ("description", "Whenever you spend [gold]Encore[/gold], [gold]Spotlighted[/gold] Companion numbers are 10% stronger this turn. The first [gold]Spotlighted[/gold] card each turn grants 1 [gold]Encore[/gold]."),
    };
