...
//
//     Sheet entry: id=rain_of_roses rarity=rare cost=2
...
public sealed class RainOfRoses : CustomCardModel, ICharacterCard, ISkillTagCard
{
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        FurinaResources.GainEncore(Owner.Creature, (IsUpgraded ? 7 : 5));
    }
