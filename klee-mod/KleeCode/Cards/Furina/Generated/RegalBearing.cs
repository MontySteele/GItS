...
//
//     Sheet entry: id=regal_bearing rarity=basic cost=1
...
public sealed class RegalBearing : CustomCardModel, ICharacterCard
{
    /// <summary>Roster identity used by character-aware mechanics such as Spotlight.</summary>
    public string CharacterId => "furina";

    public override Texture2D? CustomPortrait => RosterArt.CardPortrait("regal_bearing");
