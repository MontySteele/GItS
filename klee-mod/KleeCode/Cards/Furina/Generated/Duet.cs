...
//
//     Sheet entry: id=duet rarity=uncommon cost=1
...
public sealed class Duet : CustomCardModel, ICharacterCard
{
    /// <summary>Roster identity used by character-aware mechanics such as Spotlight.</summary>
    public string CharacterId => "furina";

    public override Texture2D? CustomPortrait => RosterArt.CardPortrait("duet");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Duet"),
        ("description", "The next [gold]Companion[/gold] card you play this turn is played an extra time. Draw {Cards:diff()} card{Cards:plural:|s}."),
    };
