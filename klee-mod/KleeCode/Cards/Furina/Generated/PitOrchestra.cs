...
//
//     Sheet entry: id=pit_orchestra rarity=uncommon cost=1
...
public sealed class PitOrchestra : CustomCardModel, ICharacterCard
{
    ...
    public override Texture2D? CustomPortrait => RosterArt.CardPortrait("pit_orchestra");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Stagehands"),
        ("description", "Whenever a [gold]Salon Member[/gold] takes its final bow, gain {PowerAmount:diff()} [gold]Block[/gold]. Whenever a [gold]Salon Member[/gold] takes its final bow, gain 2 [gold]Encore[/gold]."),
    };
