...
//
//     Sheet entry: id=full_ensemble rarity=uncommon cost=3
...
public sealed class FullEnsemble : CustomCardModel, ICharacterCard, ISkillTagCard
{
    ...
    {
        ("title", "Full Ensemble"),
        ("description", "Add 3 [gold]Salon Member(s)[/gold]. Maximum 3. Replacements perform a final bow and empower this card's later effects."),
    };
    ...
    public FullEnsemble()
        : base(3, CardType.Skill, CardRarity.Uncommon, TargetType.Self, autoAdd: false)
    {
    }
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        salonReplacements += await SalonMemberPower.Deploy(choiceContext, Owner.Creature, 3, this);
    }
