...
//
//     Sheet entry: id=tempo_change rarity=uncommon cost=1
...
public sealed class TempoChange : CustomCardModel, ICharacterCard
{
    /// <summary>Roster identity used by character-aware mechanics such as Spotlight.</summary>
    public string CharacterId => "furina";

    public override Texture2D? CustomPortrait => RosterArt.CardPortrait("tempo_change");
