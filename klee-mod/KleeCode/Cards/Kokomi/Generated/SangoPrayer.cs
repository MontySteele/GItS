...
//
//     Sheet entry: id=sango_prayer rarity=rare cost=1
...
public sealed class SangoPrayer : CustomCardModel, ICharacterCard
{
    ...
    public override Texture2D? CustomPortrait => RosterArt.CardPortrait("sango_prayer");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Sango Prayer"),
        ("description", "Apply {PowerAmount:diff()} [gold]Weak[/gold] to ALL enemies. Gain {Block:diff()} [gold]Block[/gold]."),
    };
