...
//
//     Sheet entry: id=ritual_purification rarity=common cost=1
...
public sealed class RitualPurification : CustomCardModel, ICharacterCard
{
    /// <summary>Roster identity used by character-aware mechanics such as Spotlight.</summary>
    public string CharacterId => "kokomi";

    public override Texture2D? CustomPortrait => RosterArt.CardPortrait("ritual_purification");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Ritual Purification"),
        ("description", "[gold]Exhaust[/gold] 1 card from your hand. Gain 4 [gold]Charge[/gold]. Draw {Cards:diff()} card{Cards:plural:|s}."),
    };
