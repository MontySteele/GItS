...
public sealed class MassMobilization : CustomCardModel, ICharacterCard
{
    ...
    public override List<(string, string)>? Localization => new()
    {
        ...
        ("description", "Muster 2 Inazuman allies: transform 2 cards in your hand into a random Inazuma [gold]Companion[/gold] that costs 1 less and [gold]Exhausts[/gold]. Gain 1 [gold]Charge[/gold]."),
    };
