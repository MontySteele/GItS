...
//
//     Sheet entry: id=driftglass rarity=uncommon cost=1
...
public sealed class Driftglass : CustomCardModel, IElementalCard, ICharacterCard
{
    ...
    public override Texture2D? CustomPortrait => RosterArt.CardPortrait("driftglass");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Driftglass"),
        ("description", "Deal {Damage:diff()} damage. [gold]Sly[/gold]: Deal 5 damage to a random enemy."),
    };
