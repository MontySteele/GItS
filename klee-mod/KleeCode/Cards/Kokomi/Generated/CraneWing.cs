...
//
//     Sheet entry: id=crane_wing rarity=uncommon cost=1
...
public sealed class CraneWing : CustomCardModel, ICharacterCard
{
    /// <summary>Roster identity used by character-aware mechanics such as Spotlight.</summary>
    public string CharacterId => "kokomi";

    public override Texture2D? CustomPortrait => RosterArt.CardPortrait("crane_wing");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Crane Wing"),
        ("description", "Gain {Block:diff()} [gold]Block[/gold]. [gold]Companion[/gold] cards cost 1 less this turn."),
    };
