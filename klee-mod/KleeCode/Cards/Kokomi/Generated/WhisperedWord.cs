...
//
//     Sheet entry: id=whispered_word rarity=common cost=0
...
public sealed class WhisperedWord : CustomCardModel, ICharacterCard
{
    /// <summary>Roster identity used by character-aware mechanics such as Spotlight.</summary>
    public string CharacterId => "kokomi";

    public override Texture2D? CustomPortrait => RosterArt.CardPortrait("whispered_word");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "A Whispered Word"),
        ("description", "Discard a random card. Gain {Block:diff()} [gold]Block[/gold]. [gold]Sly[/gold]: Draw 1 card."),
    };
