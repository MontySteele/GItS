...
//
//     Sheet entry: id=what_the_tokoyo_returns rarity=uncommon cost=1
...
public sealed class WhatTheTokoyoReturns : CustomCardModel, ICharacterCard
{
    /// <summary>Roster identity used by character-aware mechanics such as Spotlight.</summary>
    public string CharacterId => "kokomi";

    public override Texture2D? CustomPortrait => RosterArt.CardPortrait("what_the_tokoyo_returns");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "What the Tokoyo Returns"),
        ("description", "Choose a card from your discard pile; put it on top of your draw pile. Gain {Block:diff()} [gold]Block[/gold]. [gold]Sly[/gold]: Choose a card from your discard pile; put it on top of your draw pile."),
    };
