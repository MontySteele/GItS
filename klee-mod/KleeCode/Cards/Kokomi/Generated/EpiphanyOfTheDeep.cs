...
//
//     Sheet entry: id=epiphany_of_the_deep rarity=rare cost=2
...
public sealed class EpiphanyOfTheDeep : CustomCardModel, ICharacterCard
{
    /// <summary>Roster identity used by character-aware mechanics such as Spotlight.</summary>
    public string CharacterId => "kokomi";

    public override Texture2D? CustomPortrait => RosterArt.CardPortrait("epiphany_of_the_deep");
    ...
    {
        await PowerCmd.Apply<DarkEmbracePower>(choiceContext, Owner.Creature, 1, applier: Owner.Creature, cardSource: this);
    }
