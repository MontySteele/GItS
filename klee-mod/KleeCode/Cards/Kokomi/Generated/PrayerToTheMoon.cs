...
//
//     Sheet entry: id=prayer_to_the_moon rarity=rare cost=1
...
public sealed class PrayerToTheMoon : CustomCardModel, ICharacterCard
{
    ...
    public override Texture2D? CustomPortrait => RosterArt.CardPortrait("prayer_to_the_moon");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Prayer to the Moon"),
        ("description", "Gain 7 [gold]Charge[/gold]. Gain {Block:diff()} [gold]Block[/gold]."),
    };
    ...
    {
        KokomiResources.GainCharge(Owner.Creature, 7);
