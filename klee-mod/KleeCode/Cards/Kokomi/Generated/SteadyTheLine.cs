...
//
//     Sheet entry: id=steady_the_line rarity=common cost=0
...
public sealed class SteadyTheLine : CustomCardModel, ICharacterCard
{
    /// <summary>Roster identity used by character-aware mechanics such as Spotlight.</summary>
    public string CharacterId => "kokomi";

    public override Texture2D? CustomPortrait => RosterArt.CardPortrait("steady_the_line");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Steady the Line"),
        ("description", "Gain {Block:diff()} [gold]Block[/gold]. Discard a random card."),
    };
