...
//
//     Sheet entry: id=signal_arrow rarity=common cost=1
...
public sealed class SignalArrow : CustomCardModel, IElementalCard, ICharacterCard
{
    ...
    {
        ("title", "Signal Arrow"),
        ("description", "Deal {Damage:diff()} damage. [gold]Muster[/gold] 1."),
    };
