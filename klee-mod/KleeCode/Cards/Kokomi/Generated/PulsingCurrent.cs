...
//
//     Sheet entry: id=pulsing_current rarity=common cost=1
...
public sealed class PulsingCurrent : CustomCardModel, IElementalCard, ICharacterCard
{
    ...
    public override Texture2D? CustomPortrait => RosterArt.CardPortrait("pulsing_current");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Pulsing Current"),
        ("description", "Deal {Damage:diff()} damage. Gain 1 [gold]Charge[/gold]."),
    };
