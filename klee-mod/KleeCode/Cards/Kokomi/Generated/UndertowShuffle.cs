...
//
//     Sheet entry: id=undertow_shuffle rarity=common cost=1
...
public sealed class UndertowShuffle : CustomCardModel, ICharacterCard
{
    /// <summary>Roster identity used by character-aware mechanics such as Spotlight.</summary>
    public string CharacterId => "kokomi";

    public override Texture2D? CustomPortrait => RosterArt.CardPortrait("undertow_shuffle");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Daydream of a Quiet Life"),
        ("description", "Draw {Cards:diff()} card{Cards:plural:|s}. Discard 2 random cards."),
    };
