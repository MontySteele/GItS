...
//
//     Sheet entry: id=read_the_current rarity=uncommon cost=1
...
public sealed class ReadTheCurrent : CustomCardModel, IElementalCard, ICharacterCard
{
    ...
    public override Texture2D? CustomPortrait => RosterArt.CardPortrait("read_the_current");
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        if (KokomiResources.GetCharge(Owner.Creature) >= 10)
        {
