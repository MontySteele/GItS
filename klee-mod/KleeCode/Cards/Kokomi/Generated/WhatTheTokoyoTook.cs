...
//
//     Sheet entry: id=what_the_tokoyo_took rarity=rare cost=1
...
public sealed class WhatTheTokoyoTook : CustomCardModel, IElementalCard, ICharacterCard
{
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars =>
        new List<DynamicVar>
        {
            ...
            new CalculatedDamageVar(ValueProp.Move).WithMultiplier(static (card, _) => KokomiResources.DiscardsThisTurn(card))
        };

    // autoAdd: false -- the character-aware roster pool owns membership.
    // Partially generated character sheets must never auto-register cards.
    public WhatTheTokoyoTook()
