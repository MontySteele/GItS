...
//
//     Sheet entry: id=exposing_current rarity=uncommon cost=1
...
public sealed class ExposingCurrent : CustomCardModel, IElementalCard, ICharacterCard
{
    ...
    public override Texture2D? CustomPortrait => RosterArt.CardPortrait("exposing_current");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Exposing Current"),
        ("description", "Deal {Damage:diff()} damage. Apply {PowerAmount:diff()} [gold]Vulnerable[/gold]."),
    };
