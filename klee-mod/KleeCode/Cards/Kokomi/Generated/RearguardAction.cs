...
//
//     Sheet entry: id=rearguard_action rarity=uncommon cost=1
...
public sealed class RearguardAction : CustomCardModel, ICharacterCard
{
    /// <summary>Roster identity used by character-aware mechanics such as Spotlight.</summary>
    public string CharacterId => "kokomi";

    public override Texture2D? CustomPortrait => RosterArt.CardPortrait("rearguard_action");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Rearguard Action"),
        ("description", "Discard a random card. Gain {Block:diff()} [gold]Block[/gold]."),
    };
