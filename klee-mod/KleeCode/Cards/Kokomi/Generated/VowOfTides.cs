...
//
//     Sheet entry: id=vow_of_tides rarity=common cost=1
...
public sealed class VowOfTides : CustomCardModel, IElementalCard, ICharacterCard
{
    ...
    public override Texture2D? CustomPortrait => RosterArt.CardPortrait("vow_of_tides");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Vow of the Tides"),
