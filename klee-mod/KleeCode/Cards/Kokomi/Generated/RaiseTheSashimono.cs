...
//
//     Sheet entry: id=raise_the_sashimono rarity=uncommon cost=0
...
public sealed class RaiseTheSashimono : CustomCardModel, ICharacterCard
{
    /// <summary>Roster identity used by character-aware mechanics such as Spotlight.</summary>
    public string CharacterId => "kokomi";

    public override Texture2D? CustomPortrait => RosterArt.CardPortrait("raise_the_sashimono");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Raise the Sashimono"),
        ("description", "Give a Skill in your hand [gold]Sly[/gold] this turn. Draw {Cards:diff()} card{Cards:plural:|s}."),
    };
