...
//
//     Sheet entry: id=proto_fr_dramatic_entrance rarity=uncommon cost=1
...
public sealed class ProtoFrDramaticEntrance : CustomCardModel, ICharacterCard
{
    /// <summary>Roster identity used by character-aware mechanics such as Spotlight.</summary>
    public string CharacterId => "furina";

    public override Texture2D? CustomPortrait => RosterArt.CardPortrait("proto_fr_dramatic_entrance");
    ...
    public ProtoFrDramaticEntrance()
