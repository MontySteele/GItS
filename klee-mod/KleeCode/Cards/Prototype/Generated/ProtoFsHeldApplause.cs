...
//
//     Sheet entry: id=proto_fs_held_applause rarity=uncommon cost=1
...
public sealed class ProtoFsHeldApplause : CustomCardModel, ICharacterCard
{
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        FurinaStage.HoldFade(Owner.Creature);
    }
