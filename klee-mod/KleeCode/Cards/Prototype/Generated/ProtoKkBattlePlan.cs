...
//
//     Sheet entry: id=proto_kk_battle_plan rarity=uncommon cost=1
...
public sealed class ProtoKkBattlePlan : CustomCardModel, ICharacterCard, IPlannedCard
{
    ...
    public override Texture2D? CustomPortrait => RosterArt.CardPortrait("proto_kk_battle_plan");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Battle Plan"),
        ("description", "Draw {Cards:diff()} card{Cards:plural:|s}. [gold]Plan[/gold]: Draw {PlanCards:diff()} cards; the first Attack you play face-up this turn costs 1 less."),
    };
    ...
    public IReadOnlyList<KokomiPlan.Planned> PlanClauses =>
        new[]
        {
            ...
            new KokomiPlan.Planned(KokomiPlan.Kind.NextAttackDiscount, 0, KokomiPlan.Aim.Self),
        };
