...
//
//     Sheet entry: id=proto_ko_fish_fry rarity=uncommon cost=2
...
public sealed class ProtoKoFishFry : CustomCardModel, IElementalCard
{
    ...
    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("proto_ko_fish_fry");
    ...
    {
        await ProtoBombPower.HitAllBombedBonus(choiceContext, Owner.Creature, this, cardPlay, DynamicVars.Damage.BaseValue, DynamicVars.ExtraDamage.BaseValue);
    }
