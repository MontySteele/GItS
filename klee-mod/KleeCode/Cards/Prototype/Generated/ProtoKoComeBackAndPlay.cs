...
//
//     Sheet entry: id=proto_ko_come_back_and_play rarity=uncommon cost=0
...
public sealed class ProtoKoComeBackAndPlay : CustomCardModel
{
    protected override IEnumerable<IHoverTip> ExtraHoverTips =>
        ArmKeywordTips.ForCompanion(base.ExtraHoverTips, this);

    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("proto_ko_come_back_and_play");
    ...
    {
        await KleeExpansion.FetchFromDiscard(choiceContext, Owner, KleeExpansion.FetchKind.Companion);
        if (IsUpgraded)
        {
