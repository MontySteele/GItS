...
//
//     Sheet entry: id=proto_mc_nicole_revelation rarity=rare cost=2
...
public sealed class ProtoMcNicoleRevelation : CustomCardModel, ICompanionCard, IHexereiCard
{
    ...
    protected override IEnumerable<IHoverTip> ExtraHoverTips =>
        BaseKeywordTips.ForStrength(ArmKeywordTips.ForHexerei(ArmKeywordTips.ForCovenSpark(FurinaRiderTips.ForCompanionPerform(base.ExtraHoverTips, this), this), this), this);
    ...
    public ProtoMcNicoleRevelation()
    ...
    {
        await PowerCmd.Apply<RevelationPower>(choiceContext, Owner.Creature, 1, applier: Owner.Creature, cardSource: this);
    }
