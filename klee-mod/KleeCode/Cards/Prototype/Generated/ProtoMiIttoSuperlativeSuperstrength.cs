...
//
//     Sheet entry: id=proto_mi_itto_superlative_superstrength rarity=rare cost=2
...
public sealed class ProtoMiIttoSuperlativeSuperstrength : CustomCardModel, IElementalCard, ICompanionCard
{
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars =>
        new List<DynamicVar>
        {
            ...
            new SpotlightSystem.SpotlitBlockVar(12m)
        };

    // autoAdd: false -- the character-aware roster pool owns membership.
    // Partially generated character sheets must never auto-register cards.
    public ProtoMiIttoSuperlativeSuperstrength()
