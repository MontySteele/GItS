...
public sealed class ProtoMcRosariaRavagingConfession : CustomCardModel, IElementalCard, ICompanionCard
{
    ...
    protected override IEnumerable<IHoverTip> ExtraHoverTips =>
        BaseKeywordTips.ForVulnerable(FurinaRiderTips.ForCompanionPerform(KleeCardTooltips.ForCard(base.ExtraHoverTips, this, Element.Cryo, includesBombRules: false), this), this);
    ...
    public override List<(string, string)>? Localization => new()
    {
        ...
        ("description", "Deal {CalculatedDamage:diff()} damage. If the enemy had an aura before the hit, apply 1 [gold]Vulnerable[/gold]."),
    };
