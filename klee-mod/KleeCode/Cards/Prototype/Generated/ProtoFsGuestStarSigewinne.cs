...
//
//     Sheet entry: id=proto_fs_guest_star_sigewinne rarity=uncommon cost=1
...
public sealed class ProtoFsGuestStarSigewinne : CustomCardModel, ICharacterCard
{
    ...
    public ProtoFsGuestStarSigewinne()
    ...
    {
        await FurinaStage.GuestStar(choiceContext, Owner.Creature, "sigewinne", DynamicVars["GuestFanfare"].IntValue);
    }
