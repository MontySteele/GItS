...
public sealed class ProtoMiAyakaSoumetsu : CustomCardModel, ICompanionCard
{
    ...
    public override List<(string, string)>? Localization => new()
    {
        ...
        ("description", "At the end of each of your next {PowerAmount:diff()} turns, deal 8 [gold]Cryo[/gold] damage to ALL enemies. The last one deals 16 additional damage."),
    };
