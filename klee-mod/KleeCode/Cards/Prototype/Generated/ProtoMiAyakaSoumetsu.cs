...
//
//     Sheet entry: id=proto_mi_ayaka_soumetsu rarity=rare cost=2
...
public sealed class ProtoMiAyakaSoumetsu : CustomCardModel, ICompanionCard
{
    ...
    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("proto_mi_ayaka_soumetsu");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Kamisato Ayaka — Soumetsu"),
        ("description", "For {PowerAmount:diff()} turns, at the end of your turn deal 8 [gold]Cryo[/gold] damage to ALL enemies. After 2 turns, deal 16 [gold]Cryo[/gold] damage to ALL enemies."),
    };
    ...
    {
        await PowerCmd.Apply<SoumetsuPower>(choiceContext, Owner.Creature, DynamicVars["PowerAmount"].IntValue, applier: Owner.Creature, cardSource: this);
    }
