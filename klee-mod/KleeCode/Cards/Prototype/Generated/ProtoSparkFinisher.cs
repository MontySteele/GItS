...
//
//     Sheet entry: id=proto_spark_finisher rarity=uncommon cost=0
...
public sealed class ProtoSparkFinisher : CustomCardModel, IElementalCard, ISparkPricedCard
{
    ...
    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("proto_spark_finisher");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Firework Finale"),
        ("description", "Spend 3 [gold]Sparks[/gold]. Deal {Damage:diff()} damage."),
    };
