...
//
//     Sheet entry: id=proto_spark_sweep rarity=common cost=0
...
public sealed class ProtoSparkSweep : CustomCardModel, IElementalCard
{
    ...
    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("proto_spark_sweep");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Tinder Toss"),
        ("description", "Spend 1 [gold]Spark[/gold]. Deal {Damage:diff()} damage to ALL enemies."),
    };
