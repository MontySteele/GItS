...
//
//     Sheet entry: id=proto_kk_scout_ahead rarity=common cost=1
...
public sealed class ProtoKkScoutAhead : CustomCardModel, ICharacterCard, IPlannedCard
{
    ...
    public override Texture2D? CustomPortrait => RosterArt.CardPortrait("proto_kk_scout_ahead");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Scout Ahead"),
        ("description", "Draw 1 card. [gold]Plan[/gold]: Draw 1 card for each [gold]Plan[/gold] carried out after this one."),
    };
