...
//
//     Sheet entry: id=proto_spark_priced_draw rarity=uncommon cost=1
...
public sealed class ProtoSparkPricedDraw : CustomCardModel, ISparkPricedCard
{
    ...
    {
        ("title", "Rummage"),
        ("description", "Spend 3 [gold]Sparks[/gold]. Draw {Cards:diff()} card{Cards:plural:|s}."),
    };
