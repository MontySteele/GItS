...
//
//     Sheet entry: id=proto_fs_guest_star_charlotte rarity=uncommon cost=1
...
public sealed class ProtoFsGuestStarCharlotte : CustomCardModel, ICharacterCard
{
    ...
    public ProtoFsGuestStarCharlotte()
    ...
    {
        await FurinaStage.GuestStar(choiceContext, Owner.Creature, "charlotte", DynamicVars["GuestFanfare"].IntValue);
    }
