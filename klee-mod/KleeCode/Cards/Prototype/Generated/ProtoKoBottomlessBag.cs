...
//
//     Sheet entry: id=proto_ko_bottomless_bag rarity=common cost=0
...
public sealed class ProtoKoBottomlessBag : CustomCardModel, ISparkPricedCard
{
    protected override IEnumerable<IHoverTip> ExtraHoverTips =>
        ArmKeywordTips.ForSpark(base.ExtraHoverTips, this);

    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("proto_ko_bottomless_bag");
