...
//
//     Sheet entry: id=proto_fs_bubble_aria rarity=common cost=1
...
public sealed class ProtoFsBubbleAria : CustomCardModel, ICharacterCard
{
    ...
    {
        ("title", "Bubble Aria"),
        ("description", "Deal {Damage:diff()} damage twice. Apply [gold]Hydro[/gold]."),
    };
