...
//
//     Sheet entry: id=proto_ko_dodoco_cover rarity=common cost=1
...
public sealed class ProtoKoDodocoCover : CustomCardModel
{
    protected override IEnumerable<IHoverTip> ExtraHoverTips =>
        ArmKeywordTips.ForBomb(base.ExtraHoverTips, this);

    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("proto_ko_dodoco_cover");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Dodoco Cover"),
        ("description", "Place a [gold]Bomb[/gold] {BombSize:diff()}. Gain {Block:diff()} [gold]Block[/gold]."),
    };
