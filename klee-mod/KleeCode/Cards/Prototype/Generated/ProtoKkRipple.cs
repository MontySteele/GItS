...
//
//     Sheet entry: id=proto_kk_ripple rarity=common cost=0
...
public sealed class ProtoKkRipple : CustomCardModel, ICharacterCard, IPlannedCard
{
    ...
    public override Texture2D? CustomPortrait => RosterArt.CardPortrait("proto_kk_ripple");
    ...
    public ProtoKkRipple()
        : base(0, CardType.Skill, CardRarity.Common, KokomiTargets.PetOrSelf, autoAdd: false)
    {
    }
