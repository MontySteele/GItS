...
//
//     Sheet entry: id=proto_ko_jumpy_dumpty_mk_iii rarity=uncommon cost=1
...
public sealed class ProtoKoJumpyDumptyMkIii : CustomCardModel, IElementalCard
{
    ...
    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("proto_ko_jumpy_dumpty_mk_iii");
    ...
    public ProtoKoJumpyDumptyMkIii()
    ...
    {
        await ProtoBombPower.HitRandomAndPlant(choiceContext, Owner.Creature, this, cardPlay, DynamicVars.Damage.BaseValue, 3, DynamicVars["BombSize"].IntValue);
    }

    protected override void OnUpgrade()
    {
        DynamicVars.Damage.UpgradeValueBy(1m);
        DynamicVars["BombSize"].UpgradeValueBy(1m);
    }
}
