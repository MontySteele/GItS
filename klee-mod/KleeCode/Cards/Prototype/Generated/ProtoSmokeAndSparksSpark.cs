...
//
//     Sheet entry: id=proto_smoke_and_sparks_spark rarity=uncommon cost=0
...
public sealed class ProtoSmokeAndSparksSpark : CustomCardModel, ISparkPricedCard
{
    ...
    {
        ("title", "Powder Smoke"),
        ("description", "Spend 2 [gold]Sparks[/gold]. Apply 3 [gold]Vulnerable[/gold]."),
    };
    ...
    public ProtoSmokeAndSparksSpark()
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        await PowerCmd.Apply<VulnerablePower>(choiceContext, cardPlay.Target, 3, applier: Owner.Creature, cardSource: this);
    }
