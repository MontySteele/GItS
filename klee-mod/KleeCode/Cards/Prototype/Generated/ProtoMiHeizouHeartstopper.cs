...
//
//     Sheet entry: id=proto_mi_heizou_heartstopper rarity=common cost=1
...
public sealed class ProtoMiHeizouHeartstopper : CustomCardModel, IElementalCard, ICompanionCard
{
    ...
    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("proto_mi_heizou_heartstopper");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Shikanoin Heizou — Heartstopper Strike"),
        ("description", "Deal 6 damage. Deals 4 additional damage for each [gold]Swirl[/gold] this turn. {IfUpgraded:show:Draw 1 card.|}"),
    };
    ...
    public ProtoMiHeizouHeartstopper()
