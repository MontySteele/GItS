...
//
//     Sheet entry: id=proto_kk_treatise rarity=uncommon cost=1
...
public sealed class ProtoKkTreatise : CustomCardModel, ICharacterCard
{
    ...
    public override Texture2D? CustomPortrait => RosterArt.CardPortrait("proto_kk_treatise");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Treatise"),
        ("description", "Whenever the [gold]Bake-Kurage[/gold] carries out a [gold]Plan[/gold], draw 1 card. {IfUpgraded:show:Draw 1 card.|}"),
    };
