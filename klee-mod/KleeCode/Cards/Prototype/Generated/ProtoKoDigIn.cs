...
//
//     Sheet entry: id=proto_ko_dig_in rarity=basic cost=0
...
public sealed class ProtoKoDigIn : CustomCardModel, ISparkPricedCard
{
    protected override IEnumerable<IHoverTip> ExtraHoverTips =>
        ArmKeywordTips.ForSpark(base.ExtraHoverTips, this);

    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("proto_ko_dig_in");
