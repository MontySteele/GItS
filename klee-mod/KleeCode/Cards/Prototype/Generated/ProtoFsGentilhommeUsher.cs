...
//
//     Sheet entry: id=proto_fs_gentilhomme_usher rarity=common cost=1
...
public sealed class ProtoFsGentilhommeUsher : CustomCardModel, ICharacterCard
{
    ...
    public override List<(string, string)>? Localization => new()
    {
        ...
        ("description", "Summon Usher. If he is already on stage, [gold]Raise[/gold] 3 on him instead."),
    };
    ...
    public ProtoFsGentilhommeUsher()
