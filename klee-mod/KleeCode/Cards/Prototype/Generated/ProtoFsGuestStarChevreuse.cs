...
//
//     Sheet entry: id=proto_fs_guest_star_chevreuse rarity=uncommon cost=1
...
public sealed class ProtoFsGuestStarChevreuse : CustomCardModel, ICharacterCard
{
    ...
    public ProtoFsGuestStarChevreuse()
    ...
    {
        await FurinaStage.GuestStar(choiceContext, Owner.Creature, "chevreuse", DynamicVars["GuestFanfare"].IntValue);
    }
