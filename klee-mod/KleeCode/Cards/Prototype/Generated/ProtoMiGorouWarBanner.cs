...
public sealed class ProtoMiGorouWarBanner : CustomCardModel, ICompanionCard
{
    ...
    public override List<(string, string)>? Localization => new()
    {
        ...
        ("description", "Gain 2 [gold]Dexterity[/gold] for 2 turns."),
    };
    ...
    {
        await PowerCmd.Apply<DexterityPower>(choiceContext, Owner.Creature, 2, applier: Owner.Creature, cardSource: this);
