...
//
//     Sheet entry: id=proto_spark_priced_strike rarity=uncommon cost=0
...
public sealed class ProtoSparkPricedStrike : CustomCardModel, IElementalCard, ISparkPricedCard
{
    ...
    public override List<(string, string)>? Localization => new()
    {
        ...
        ("description", "Spend 3 [gold]Sparks[/gold]. Deal {Damage:diff()} damage twice."),
    };
