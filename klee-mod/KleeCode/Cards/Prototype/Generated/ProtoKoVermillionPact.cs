...
//
//     Sheet entry: id=proto_ko_vermillion_pact rarity=rare cost=2
...
public sealed class ProtoKoVermillionPact : CustomCardModel
{
    ...
    {
        await PowerCmd.Apply<VermillionPactPower>(choiceContext, Owner.Creature, 1, applier: Owner.Creature, cardSource: this);
    }
