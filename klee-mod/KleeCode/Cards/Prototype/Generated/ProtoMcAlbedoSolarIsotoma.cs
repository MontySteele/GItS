...
//
//     Sheet entry: id=proto_mc_albedo_solar_isotoma rarity=rare cost=1
...
public sealed class ProtoMcAlbedoSolarIsotoma : CustomCardModel, ICompanionCard
{
    ...
    public override List<(string, string)>? Localization => new()
    {
        ...
        ("description", "At the end of your turn, if any enemy has an aura, deal 8 damage to that enemy and gain 4 [gold]Block[/gold]."),
    };
    ...
    public ProtoMcAlbedoSolarIsotoma()
    ...
    {
        await PowerCmd.Apply<SolarIsotomaBloomPower>(choiceContext, Owner.Creature, 1, applier: Owner.Creature, cardSource: this);
    }
