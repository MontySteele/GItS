...
//
//     Sheet entry: id=proto_itto_superlative_superstrength_priced rarity=rare cost=3
...
public sealed class ProtoIttoSuperlativeSuperstrengthPriced : CustomCardModel, ICompanionCard
{
    ...
    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("proto_itto_superlative_superstrength_priced");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Itto - Superlative Guard"),
    ...
    public ProtoIttoSuperlativeSuperstrengthPriced()
