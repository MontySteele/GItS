...
//
//     Sheet entry: id=proto_spark_double_tap rarity=common cost=0
...
public sealed class ProtoSparkDoubleTap : CustomCardModel, IElementalCard
{
    ...
    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("proto_spark_double_tap");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Bang Bang!"),
        ("description", "Spend 2 [gold]Sparks[/gold]. Deal {Damage:diff()} damage to random enemies twice."),
    };
