...
//
//     Sheet entry: id=proto_kk_undertow rarity=uncommon cost=1
...
public sealed class ProtoKkUndertow : CustomCardModel, IElementalCard, ICharacterCard
{
    ...
    public override List<(string, string)>? Localization => new()
    {
        ...
        ("description", "[gold]Surge[/gold]. Gain Block equal to half the damage dealt."),
    };
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        await KokomiTide.BlockHalfSurge(choiceContext, Owner.Creature);
    }
