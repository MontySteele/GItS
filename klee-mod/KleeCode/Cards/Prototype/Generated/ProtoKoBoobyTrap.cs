...
//
//     Sheet entry: id=proto_ko_booby_trap rarity=common cost=0
...
public sealed class ProtoKoBoobyTrap : CustomCardModel, ISparkPricedCard
{
    protected override IEnumerable<IHoverTip> ExtraHoverTips =>
        ArmKeywordTips.ForMine(ArmKeywordTips.ForSpark(base.ExtraHoverTips, this), this);

    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("proto_ko_booby_trap");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Booby Trap"),
        ("description", "Place a [gold]Mine[/gold] {BombSize:diff()}."),
    };
