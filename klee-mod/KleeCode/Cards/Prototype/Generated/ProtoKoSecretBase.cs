...
//
//     Sheet entry: id=proto_ko_secret_base rarity=uncommon cost=1
...
public sealed class ProtoKoSecretBase : CustomCardModel
{
    protected override IEnumerable<IHoverTip> ExtraHoverTips =>
        ArmKeywordTips.ForBomb(base.ExtraHoverTips, this);

    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("proto_ko_secret_base");
    ...
    {
        await PowerCmd.Apply<SecretBasePower>(choiceContext, Owner.Creature, DynamicVars["PowerAmount"].IntValue, applier: Owner.Creature, cardSource: this);
    }
