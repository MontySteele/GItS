...
//
//     Sheet entry: id=proto_fs_oratrices_verdict rarity=uncommon cost=0
...
public sealed class ProtoFsOratricesVerdict : CustomCardModel, ICharacterCard
{
    /// <summary>Roster identity used by character-aware mechanics such as Spotlight.</summary>
    public string CharacterId => "furina";

    public override Texture2D? CustomPortrait => RosterArt.CardPortrait("proto_fs_oratrices_verdict");
    ...
    public ProtoFsOratricesVerdict()
    ...
    {
        FurinaStage.SetVerdict(Owner.Creature, cardPlay.Target);
