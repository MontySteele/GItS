...
//
//     Sheet entry: id=proto_fr_aria_of_recompense rarity=basic cost=1
...
public sealed class ProtoFrAriaOfRecompense : CustomCardModel, ICharacterCard
{
    /// <summary>Roster identity used by character-aware mechanics such as Spotlight.</summary>
    public string CharacterId => "furina";

    protected override IEnumerable<IHoverTip> ExtraHoverTips =>
        ArmKeywordTips.ForEncore(base.ExtraHoverTips, this);
    ...
    public ProtoFrAriaOfRecompense()
