...
//
//     Sheet entry: id=proto_fs_tide_of_applause rarity=uncommon cost=1
...
public sealed class ProtoFsTideOfApplause : CustomCardModel, ICharacterCard
{
    ...
    {
        await PowerCmd.Apply<TideOfApplausePower>(choiceContext, Owner.Creature, DynamicVars["PowerAmount"].IntValue, applier: Owner.Creature, cardSource: this);
    }
