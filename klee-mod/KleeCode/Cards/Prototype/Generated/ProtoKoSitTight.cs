...
//
//     Sheet entry: id=proto_ko_sit_tight rarity=uncommon cost=0
...
public sealed class ProtoKoSitTight : CustomCardModel, ISparkPricedCard
{
    ...
    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("proto_ko_sit_tight");
