...
//
//     Sheet entry: id=proto_ko_patience_klee rarity=uncommon cost=1
...
public sealed class ProtoKoPatienceKlee : CustomCardModel
{
    protected override IEnumerable<IHoverTip> ExtraHoverTips =>
        ArmKeywordTips.ForSetOff(ArmKeywordTips.ForBomb(base.ExtraHoverTips, this), this);

    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("proto_ko_patience_klee");
    ...
    {
        await PowerCmd.Apply<PatienceKleePower>(choiceContext, Owner.Creature, DynamicVars["PowerAmount"].IntValue, applier: Owner.Creature, cardSource: this);
    }
