...
//
//     Sheet entry: id=proto_thoma_crimson_ooyoroi_priced rarity=uncommon cost=3
...
public sealed class ProtoThomaCrimsonOoyoroiPriced : CustomCardModel, IElementalCard, ICompanionCard
{
    ...
    public ProtoThomaCrimsonOoyoroiPriced()
        : base(3, CardType.Attack, CardRarity.Uncommon, TargetType.AnyEnemy, autoAdd: false)
    {
    }
