...
//
//     Sheet entry: id=proto_ko_wait_for_it rarity=uncommon cost=0
...
public sealed class ProtoKoWaitForIt : CustomCardModel
{
    ...
    {
        await PowerCmd.Apply<WaitForItPower>(choiceContext, Owner.Creature, DynamicVars["PowerAmount"].IntValue, applier: Owner.Creature, cardSource: this);
    }
