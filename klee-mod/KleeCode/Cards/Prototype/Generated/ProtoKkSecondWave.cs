...
//
//     Sheet entry: id=proto_kk_second_wave rarity=common cost=1
...
public sealed class ProtoKkSecondWave : CustomCardModel, ICharacterCard, IPlannedCard
{
    ...
    {
        ("title", "Second Wave"),
        ("description", "Gain {Block:diff()} [gold]Block[/gold]. [gold]Plan[/gold]: Your next Plan is carried out twice."),
    };
    ...
    public IReadOnlyList<KokomiPlan.Planned> PlanClauses =>
        new[]
        {
            new KokomiPlan.Planned(KokomiPlan.Kind.NextPlanExtraCarryOut, 0, KokomiPlan.Aim.Self),
        };
