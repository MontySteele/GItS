...
//
//     Sheet entry: id=proto_fr_flood_of_emotion rarity=rare cost=1
...
public sealed class ProtoFrFloodOfEmotion : CustomCardModel, IElementalCard, ICharacterCard
{
    ...
    public override Texture2D? CustomPortrait => RosterArt.CardPortrait("proto_fr_flood_of_emotion");
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        if (FurinaResources.ReadableFanfare(Owner.Creature) >= 10)
        {
