...
//
//     Sheet entry: id=proto_ko_playdate rarity=common cost=0
...
public sealed class ProtoKoPlaydate : CustomCardModel
{
    ...
    {
        ("title", "Playdate"),
        ("description", "The next [gold]Companion[/gold] card you play this turn costs 1 less. Place a [gold]Bomb[/gold] {BombSize:diff()}."),
    };
    ...
    {
        await PowerCmd.Apply<PlaydatePower>(choiceContext, Owner.Creature, 1, applier: Owner.Creature, cardSource: this);
