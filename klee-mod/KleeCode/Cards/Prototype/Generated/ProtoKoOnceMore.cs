...
//
//     Sheet entry: id=proto_ko_once_more rarity=uncommon cost=0
...
public sealed class ProtoKoOnceMore : CustomCardModel, ISparkPricedCard
{
    protected override IEnumerable<IHoverTip> ExtraHoverTips =>
        ArmKeywordTips.ForSpark(ArmKeywordTips.ForSetOff(base.ExtraHoverTips, this), this);

    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("proto_ko_once_more");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Once More!"),
        ("description", "Return the last [gold]Set off[/gold] card you played this combat to your hand."),
    };
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        await KleeOverhaulLedger.ReturnLastSetOff(Owner);
    }
