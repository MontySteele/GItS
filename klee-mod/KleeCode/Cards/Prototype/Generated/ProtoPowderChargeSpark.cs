...
//
//     Sheet entry: id=proto_powder_charge_spark rarity=uncommon cost=0
...
public sealed class ProtoPowderChargeSpark : CustomCardModel, ISparkPricedCard
{
    ...
    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("proto_powder_charge_spark");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Set It Off"),
        ("description", "Spend 2 [gold]Sparks[/gold]. Detonate an enemy's [gold]Bombs[/gold]. Detonations deal 4 more damage."),
    };
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        await BombPower.DetonateOn(choiceContext, cardPlay.Target, 4);
    }
