...
//
//     Sheet entry: id=proto_mc_amber_fiery_rain rarity=uncommon cost=1
...
public sealed class ProtoMcAmberFieryRain : CustomCardModel, IElementalCard, ICompanionCard
{
    ...
    public override List<(string, string)>? Localization => new()
    {
        ...
        ("description", "Deal {CalculatedDamage:diff()} damage to ALL enemies 3 times."),
    };
