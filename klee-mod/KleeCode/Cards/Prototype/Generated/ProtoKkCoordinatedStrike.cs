...
//
//     Sheet entry: id=proto_kk_coordinated_strike rarity=uncommon cost=1
...
public sealed class ProtoKkCoordinatedStrike : CustomCardModel, IElementalCard, ICharacterCard, IPlannedCard
{
    ...
    public override List<(string, string)>? Localization => new()
    {
        ...
        ("description", "Deal {Damage:diff()} damage. [gold]Plan[/gold]: Next turn, each other player's Attacks deal 3 additional damage."),
    };
    ...
    public IReadOnlyList<KokomiPlan.Planned> PlanClauses =>
        new[]
        {
            new KokomiPlan.Planned(KokomiPlan.Kind.OthersAttackDamageThisTurn, 3, KokomiPlan.Aim.Self),
        };
    ...
    public ProtoKkCoordinatedStrike()
        : base(1, CardType.Attack, CardRarity.Uncommon, KokomiTargets.PetOrEnemy, autoAdd: false)
    {
    }
