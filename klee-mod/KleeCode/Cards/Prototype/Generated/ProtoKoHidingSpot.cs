...
//
//     Sheet entry: id=proto_ko_hiding_spot rarity=common cost=1
...
public sealed class ProtoKoHidingSpot : CustomCardModel
{
    protected override IEnumerable<IHoverTip> ExtraHoverTips =>
        ArmKeywordTips.ForMine(base.ExtraHoverTips, this);

    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("proto_ko_hiding_spot");
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        await ProtoBombPower.PlaceOnRandom(choiceContext, Owner.Creature, DynamicVars["BombSize"].IntValue, isMine: true, payloadMineAll: 0, cardSource: this);
    }
