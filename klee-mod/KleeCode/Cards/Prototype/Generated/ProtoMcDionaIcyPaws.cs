...
//
//     Sheet entry: id=proto_mc_diona_icy_paws rarity=common cost=1
...
public sealed class ProtoMcDionaIcyPaws : CustomCardModel, ICompanionCard
{
    ...
    public override List<(string, string)>? Localization => new()
    {
        ...
        ("description", "Gain 6 [gold]Block[/gold]. When this [gold]Block[/gold] absorbs damage, apply [gold]Cryo[/gold] to the attacker."),
    };
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        await PowerCmd.Apply<IcyPawsPower>(choiceContext, Owner.Creature, 6, applier: Owner.Creature, cardSource: this);
    }
