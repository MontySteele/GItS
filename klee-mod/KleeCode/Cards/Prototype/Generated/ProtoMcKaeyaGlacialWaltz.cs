...
public sealed class ProtoMcKaeyaGlacialWaltz : CustomCardModel, ICompanionCard
{
    ...
    public override List<(string, string)>? Localization => new()
    {
        ...
        ("description", "For 3 turns, at the end of your turn deal 6 [gold]Cryo[/gold] damage to a random enemy."),
    };
    ...
    {
        await PowerCmd.Apply<GlacialWaltzPower>(choiceContext, Owner.Creature, 3, applier: Owner.Creature, cardSource: this);
    }
