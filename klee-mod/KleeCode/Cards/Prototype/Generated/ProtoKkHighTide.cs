...
//
//     Sheet entry: id=proto_kk_high_tide rarity=uncommon cost=1
...
public sealed class ProtoKkHighTide : CustomCardModel, ICharacterCard
{
    ...
    public override Texture2D? CustomPortrait => RosterArt.CardPortrait("proto_kk_high_tide");
