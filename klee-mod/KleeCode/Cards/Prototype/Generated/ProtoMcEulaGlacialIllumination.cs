...
//
//     Sheet entry: id=proto_mc_eula_glacial_illumination rarity=rare cost=1
...
public sealed class ProtoMcEulaGlacialIllumination : CustomCardModel, ICompanionCard
{
    ...
    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("proto_mc_eula_glacial_illumination");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Eula — Glacial Illumination"),
        ("description", "Place a [gold]Lightfall Sword[/gold]. In {PowerAmount:diff()} turns it deals 8 damage, and 5 additional damage for each Attack you play before then."),
    };
    ...
    public ProtoMcEulaGlacialIllumination()
