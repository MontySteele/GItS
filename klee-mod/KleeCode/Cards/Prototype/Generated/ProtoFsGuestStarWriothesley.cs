...
//
//     Sheet entry: id=proto_fs_guest_star_wriothesley rarity=uncommon cost=1
...
public sealed class ProtoFsGuestStarWriothesley : CustomCardModel, ICharacterCard
{
    /// <summary>Roster identity used by character-aware mechanics such as Spotlight.</summary>
    public string CharacterId => "furina";

    protected override IEnumerable<IHoverTip> ExtraHoverTips =>
        ArmKeywordTips.ForFanfare(ArmKeywordTips.ForWriothesley(ArmKeywordTips.ForGuestStar(base.ExtraHoverTips, this), this), this);
    ...
    public ProtoFsGuestStarWriothesley()
