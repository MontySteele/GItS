...
//
//     Sheet entry: id=proto_ko_sugar_rush rarity=rare cost=0
...
public sealed class ProtoKoSugarRush : CustomCardModel, ISparkPricedCard
{
    public override IEnumerable<CardKeyword> CanonicalKeywords =>
        new[] { CardKeyword.Exhaust };

    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("proto_ko_sugar_rush");
