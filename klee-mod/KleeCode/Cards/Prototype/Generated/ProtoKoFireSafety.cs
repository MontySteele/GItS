...
//
//     Sheet entry: id=proto_ko_fire_safety rarity=common cost=0
...
public sealed class ProtoKoFireSafety : CustomCardModel
{
    protected override IEnumerable<IHoverTip> ExtraHoverTips =>
        ArmKeywordTips.ForBomb(base.ExtraHoverTips, this);

    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("proto_ko_fire_safety");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Fire Safety"),
        ("description", "Gain {Block:diff()} [gold]Block[/gold]. If a [gold]Bomb[/gold] triggered an [gold]Elemental Reaction[/gold] this turn, gain {IfUpgraded:show:8|6} additional [gold]Block[/gold]."),
    };
