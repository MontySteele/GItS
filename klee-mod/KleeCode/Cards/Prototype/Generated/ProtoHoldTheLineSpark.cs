...
//
//     Sheet entry: id=proto_hold_the_line_spark rarity=uncommon cost=0
...
public sealed class ProtoHoldTheLineSpark : CustomCardModel, ISparkPricedCard
{
    protected override IEnumerable<IHoverTip> ExtraHoverTips =>
        ArmKeywordTips.ForSpark(base.ExtraHoverTips, this);

    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("proto_hold_the_line_spark");
