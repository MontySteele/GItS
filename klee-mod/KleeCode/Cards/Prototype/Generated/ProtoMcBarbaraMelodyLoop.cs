...
//
//     Sheet entry: id=proto_mc_barbara_melody_loop rarity=uncommon cost=1
...
public sealed class ProtoMcBarbaraMelodyLoop : CustomCardModel, ICompanionCard
{
    ...
    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("proto_mc_barbara_melody_loop");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Barbara — Melody Loop"),
        ("description", "Gain {CalculatedBlock:diff()} [gold]Block[/gold]. For {PowerAmount:diff()} turns, at the start of your turn apply [gold]Hydro[/gold] to the enemy."),
    };
    ...
    public ProtoMcBarbaraMelodyLoop()
