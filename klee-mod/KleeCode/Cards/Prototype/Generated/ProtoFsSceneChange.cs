...
//
//     Sheet entry: id=proto_fs_scene_change rarity=common cost=0
...
public sealed class ProtoFsSceneChange : CustomCardModel, ICharacterCard
{
    ...
    {
        FurinaStage.SceneChange(Owner.Creature);
        if (IsUpgraded)
        {
