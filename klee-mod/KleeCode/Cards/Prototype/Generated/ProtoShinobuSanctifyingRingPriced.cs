...
//
//     Sheet entry: id=proto_shinobu_sanctifying_ring_priced rarity=common cost=3
...
public sealed class ProtoShinobuSanctifyingRingPriced : CustomCardModel, IElementalCard, ICompanionCard
{
    ...
    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("proto_shinobu_sanctifying_ring_priced");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Shinobu - Sanctifying Circle"),
        ("description", "Deal {CalculatedDamage:diff()} damage to ALL enemies. Gain {Block:diff()} [gold]Block[/gold]."),
    };
    ...
    public ProtoShinobuSanctifyingRingPriced()
        : base(3, CardType.Skill, CardRarity.Common, TargetType.AllEnemies, autoAdd: false)
    {
    }
