...
//
//     Sheet entry: id=proto_ko_one_more_charge rarity=uncommon cost=1
...
public sealed class ProtoKoOneMoreCharge : CustomCardModel
{
    protected override IEnumerable<IHoverTip> ExtraHoverTips =>
        ArmKeywordTips.ForBomb(base.ExtraHoverTips, this);

    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("proto_ko_one_more_charge");
    ...
    {
        await ProtoBombPower.GrowLargestBy(choiceContext, Owner, DynamicVars["Grow"].IntValue, 20, 1);
    }
