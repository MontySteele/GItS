...
//
//     Sheet entry: id=proto_ko_sparkling_burst rarity=uncommon cost=0
...
public sealed class ProtoKoSparklingBurst : CustomCardModel, ISparkPricedCard
{
    protected override IEnumerable<IHoverTip> ExtraHoverTips =>
        ArmKeywordTips.ForSpark(ArmKeywordTips.ForBomb(base.ExtraHoverTips, this), this);

    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("proto_ko_sparkling_burst");

    public override List<(string, string)>? Localization => new()
    {
        ("title", "Sparkling Burst"),
        ("description", "Gain 1 [gold]Energy[/gold]. If a [gold]Bomb[/gold] went off this turn, gain 1 more."),
    };
