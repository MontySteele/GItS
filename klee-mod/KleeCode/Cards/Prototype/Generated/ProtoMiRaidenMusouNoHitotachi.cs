...
//
//     Sheet entry: id=proto_mi_raiden_musou_no_hitotachi rarity=rare cost=3
...
public sealed class ProtoMiRaidenMusouNoHitotachi : CustomCardModel, IElementalCard, ICompanionCard
{
    ...
    protected override IEnumerable<IHoverTip> ExtraHoverTips =>
        ArmKeywordTips.ForCompanion(ArmKeywordTips.ForCovenSpark(KleeCardTooltips.ForCard(base.ExtraHoverTips, this, Element.Electro, includesBombRules: false), this), this);

    public override Texture2D? CustomPortrait => KleeArt.CardPortrait("proto_mi_raiden_musou_no_hitotachi");
    ...
    public ProtoMiRaidenMusouNoHitotachi()
