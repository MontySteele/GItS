...
//
//     Sheet entry: id=proto_mc_qiqi_herald_of_frost rarity=uncommon cost=1
...
public sealed class ProtoMcQiqiHeraldOfFrost : CustomCardModel, ICompanionCard
{
    ...
    public ProtoMcQiqiHeraldOfFrost()
    ...
    {
        await PowerCmd.Apply<HeraldOfFrostPower>(choiceContext, Owner.Creature, DynamicVars["PowerAmount"].IntValue, applier: Owner.Creature, cardSource: this);
    }
