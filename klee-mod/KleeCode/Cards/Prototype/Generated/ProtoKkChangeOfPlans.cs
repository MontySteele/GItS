...
//
//     Sheet entry: id=proto_kk_change_of_plans rarity=common cost=0
...
public sealed class ProtoKkChangeOfPlans : CustomCardModel, ICharacterCard
{
    ...
    public override Texture2D? CustomPortrait => RosterArt.CardPortrait("proto_kk_change_of_plans");
    ...
    {
        await KokomiPlan.ResolveFront(choiceContext, Owner.Creature);
    }
