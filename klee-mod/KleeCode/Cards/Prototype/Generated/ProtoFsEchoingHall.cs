...
//
//     Sheet entry: id=proto_fs_echoing_hall rarity=uncommon cost=1
...
public sealed class ProtoFsEchoingHall : CustomCardModel, ICharacterCard
{
    ...
    {
        await PowerCmd.Apply<EchoingHallPower>(choiceContext, Owner.Creature, 1, applier: Owner.Creature, cardSource: this);
    }
