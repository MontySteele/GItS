...
public sealed class ProtoKkNereidsAscension : CustomCardModel, ICharacterCard
{
    ...
    {
        await PowerCmd.Apply<NereidsAscensionPower>(choiceContext, Owner.Creature, 1, applier: Owner.Creature, cardSource: this);
    }
