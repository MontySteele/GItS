...
/// <summary>
/// The Drillmaster of Watatsumi -- Bugslayer, dressed for Inazuma.
///
...
/// base event's clauses are in <see cref="BugslayerMirror"/>, written
/// once and shared by every nation that dresses this event; this class
/// is a NAME. `ModelDb.GetEntry` slugifies it into
/// `DRILLMASTER_OF_WATATSUMI`, `EventModel.Title` and `InitialDescription`
...
/// </summary>
public sealed class DrillmasterOfWatatsumi : BugslayerMirror
{
}
