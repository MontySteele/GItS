...
/// <summary>
/// The Banked Forge at Musoujin -- Amalgamator, dressed for Inazuma.
///
...
/// base event's clauses are in <see cref="AmalgamatorMirror"/>, written
/// once and shared by every nation that dresses this event; this class
/// is a NAME. `ModelDb.GetEntry` slugifies it into
/// `BANKED_FORGE_AT_MUSOUJIN`, `EventModel.Title` and `InitialDescription`
...
/// </summary>
public sealed class BankedForgeAtMusoujin : AmalgamatorMirror
{
}
