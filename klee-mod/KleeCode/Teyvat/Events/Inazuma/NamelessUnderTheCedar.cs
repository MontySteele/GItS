...
/// <summary>
/// The Nameless Under the Cedar -- SpiritGrafter, dressed for Inazuma.
///
...
/// base event's clauses are in <see cref="SpiritGrafterMirror"/>, written
/// once and shared by every nation that dresses this event; this class
/// is a NAME. `ModelDb.GetEntry` slugifies it into
/// `NAMELESS_UNDER_THE_CEDAR`, `EventModel.Title` and `InitialDescription`
...
/// </summary>
public sealed class NamelessUnderTheCedar : SpiritGrafterMirror
{
}
