...
/// <summary>
/// The Wisteria Well of Chinju Forest -- ColossalFlower, dressed for Inazuma.
///
...
/// base event's clauses are in <see cref="ColossalFlowerMirror"/>, written
/// once and shared by every nation that dresses this event; this class
/// is a NAME. `ModelDb.GetEntry` slugifies it into
/// `WISTERIA_WELL_OF_CHINJU_FOREST`, `EventModel.Title` and `InitialDescription`
...
/// </summary>
public sealed class WisteriaWellOfChinjuForest : ColossalFlowerMirror
{
}
