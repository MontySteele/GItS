...
/// <summary>
/// The Quartermaster's Tent, Watatsumi -- WelcomeToWongos, dressed for Inazuma.
///
...
/// base event's clauses are in <see cref="WelcomeToWongosMirror"/>, written
/// once and shared by every nation that dresses this event; this class
/// is a NAME. `ModelDb.GetEntry` slugifies it into
/// `QUARTERMASTERS_TENT_WATATSUMI`, `EventModel.Title` and `InitialDescription`
...
/// </summary>
public sealed class QuartermastersTentWatatsumi : WelcomeToWongosMirror
{
}
