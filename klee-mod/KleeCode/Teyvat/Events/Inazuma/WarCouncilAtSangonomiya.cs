...
/// <summary>
/// The War Council at Sangonomiya -- ColorfulPhilosophers, dressed for Inazuma.
///
...
/// base event's clauses are in <see cref="ColorfulPhilosophersMirror"/>, written
/// once and shared by every nation that dresses this event; this class
/// is a NAME. `ModelDb.GetEntry` slugifies it into
/// `WAR_COUNCIL_AT_SANGONOMIYA`, `EventModel.Title` and `InitialDescription`
...
/// </summary>
public sealed class WarCouncilAtSangonomiya : ColorfulPhilosophersMirror
{
}
