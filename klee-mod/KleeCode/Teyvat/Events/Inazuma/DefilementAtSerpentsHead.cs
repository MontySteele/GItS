...
/// <summary>
/// Defilement at Serpent's Head -- Symbiote, dressed for Inazuma.
///
...
/// base event's clauses are in <see cref="SymbioteMirror"/>, written
/// once and shared by every nation that dresses this event; this class
/// is a NAME. `ModelDb.GetEntry` slugifies it into
/// `DEFILEMENT_AT_SERPENTS_HEAD`, `EventModel.Title` and `InitialDescription`
...
/// </summary>
public sealed class DefilementAtSerpentsHead : SymbioteMirror
{
}
