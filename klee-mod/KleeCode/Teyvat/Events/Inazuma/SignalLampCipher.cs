...
/// <summary>
/// The Signal-Lamp Cipher -- TheLanternKey, dressed for Inazuma.
///
...
/// base event's clauses are in <see cref="TheLanternKeyMirror"/>, written
/// once and shared by every nation that dresses this event; this class
/// is a NAME. `ModelDb.GetEntry` slugifies it into
/// `SIGNAL_LAMP_CIPHER`, `EventModel.Title` and `InitialDescription`
...
/// </summary>
public sealed class SignalLampCipher : TheLanternKeyMirror
{
}
