...
/// <summary>
/// The Hitogata Storehouse -- DollRoom, dressed for Inazuma.
///
...
/// base event's clauses are in <see cref="DollRoomMirror"/>, written
/// once and shared by every nation that dresses this event; this class
/// is a NAME. `ModelDb.GetEntry` slugifies it into
/// `HITOGATA_STOREHOUSE`, `EventModel.Title` and `InitialDescription`
...
/// </summary>
public sealed class HitogataStorehouse : DollRoomMirror
{
}
