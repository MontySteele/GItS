...
/// <summary>
/// The Bramble Line Below Wolvendom -- DenseVegetation, dressed for Mondstadt.
///
...
/// base event's clauses are in <see cref="DenseVegetationMirror"/>, written
/// once and shared by every nation that dresses this event; this class
/// is a NAME. `ModelDb.GetEntry` slugifies it into
/// `BRAMBLE_LINE_BELOW_WOLVENDOM`, `EventModel.Title` and `InitialDescription`
...
/// </summary>
public sealed class BrambleLineBelowWolvendom : DenseVegetationMirror
{
}
