...
/// <summary>
/// The Cliffside Seed Near Cape Oath -- SapphireSeed, dressed for Mondstadt.
///
...
/// base event's clauses are in <see cref="SapphireSeedMirror"/>, written
/// once and shared by every nation that dresses this event; this class
/// is a NAME. `ModelDb.GetEntry` slugifies it into
/// `CLIFFSIDE_SEED_NEAR_CAPE_OATH`, `EventModel.Title` and `InitialDescription`
...
/// </summary>
public sealed class CliffsideSeedNearCapeOath : SapphireSeedMirror
{
}
