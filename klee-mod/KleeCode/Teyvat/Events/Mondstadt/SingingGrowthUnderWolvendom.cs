...
/// <summary>
/// The Singing Growth Under Wolvendom -- LuminousChoir, dressed for Mondstadt.
///
...
/// base event's clauses are in <see cref="LuminousChoirMirror"/>, written
/// once and shared by every nation that dresses this event; this class
/// is a NAME. `ModelDb.GetEntry` slugifies it into
/// `SINGING_GROWTH_UNDER_WOLVENDOM`, `EventModel.Title` and `InitialDescription`
...
/// </summary>
public sealed class SingingGrowthUnderWolvendom : LuminousChoirMirror
{
}
