...
/// <summary>
/// The Unmarked Crates -- ThisOrThat, dressed for Mondstadt.
///
...
/// `UNMARKED_CRATES`, `EventModel.Title` and `InitialDescription`
...
/// </summary>
public sealed class UnmarkedCrates : ThisOrThatMirror
{
}
