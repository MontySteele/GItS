...
/// <summary>
/// The Cracked Tablet at Stormterror's Lair -- TabletOfTruth, dressed for Mondstadt.
///
...
/// base event's clauses are in <see cref="TabletOfTruthMirror"/>, written
/// once and shared by every nation that dresses this event; this class
/// is a NAME. `ModelDb.GetEntry` slugifies it into
/// `CRACKED_TABLET_AT_STORMTERRORS_LAIR`, `EventModel.Title` and `InitialDescription`
...
/// </summary>
public sealed class CrackedTabletAtStormterrorsLair : TabletOfTruthMirror
{
}
