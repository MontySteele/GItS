...
/// <summary>
/// The Windfalcon's Roost -- ByrdonisNest, dressed for Mondstadt.
///
...
/// base event's clauses are in <see cref="ByrdonisNestMirror"/>, written
/// once and shared by every nation that dresses this event; this class
/// is a NAME. `ModelDb.GetEntry` slugifies it into
/// `WINDFALCONS_ROOST`, `EventModel.Title` and `InitialDescription`
...
/// </summary>
public sealed class WindfalconsRoost : ByrdonisNestMirror
{
}
