...
/// <summary>
/// The Guild's Standing Commission at Cape Oath -- TheLegendsWereTrue, dressed for Mondstadt.
///
...
/// base event's clauses are in <see cref="TheLegendsWereTrueMirror"/>, written
/// once and shared by every nation that dresses this event; this class
/// is a NAME. `ModelDb.GetEntry` slugifies it into
/// `GUILDS_STANDING_COMMISSION_AT_CAPE_OATH`, `EventModel.Title` and `InitialDescription`
...
/// </summary>
public sealed class GuildsStandingCommissionAtCapeOath : TheLegendsWereTrueMirror
{
}
