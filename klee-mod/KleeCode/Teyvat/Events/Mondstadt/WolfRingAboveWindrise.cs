...
/// <summary>
/// The Wolf-Ring Above Windrise -- MorphicGrove, dressed for Mondstadt.
///
...
/// base event's clauses are in <see cref="MorphicGroveMirror"/>, written
/// once and shared by every nation that dresses this event; this class
/// is a NAME. `ModelDb.GetEntry` slugifies it into
/// `WOLF_RING_ABOVE_WINDRISE`, `EventModel.Title` and `InitialDescription`
...
/// </summary>
public sealed class WolfRingAboveWindrise : MorphicGroveMirror
{
}
