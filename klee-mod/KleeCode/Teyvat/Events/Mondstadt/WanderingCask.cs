...
/// <summary>
/// The Wandering Cask -- AromaOfChaos, dressed for Mondstadt.
///
...
/// base event's clauses are in <see cref="AromaOfChaosMirror"/>, written
/// once and shared by every nation that dresses this event; this class
/// is a NAME. `ModelDb.GetEntry` slugifies it into
/// `WANDERING_CASK`, `EventModel.Title` and `InitialDescription`
...
/// </summary>
public sealed class WanderingCask : AromaOfChaosMirror
{
}
