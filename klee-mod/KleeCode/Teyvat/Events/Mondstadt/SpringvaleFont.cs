...
/// <summary>
/// The Springvale Font -- Wellspring, dressed for Mondstadt.
///
...
/// base event's clauses are in <see cref="WellspringMirror"/>, written
/// once and shared by every nation that dresses this event; this class
/// is a NAME. `ModelDb.GetEntry` slugifies it into
/// `SPRINGVALE_FONT`, `EventModel.Title` and `InitialDescription`
...
/// </summary>
public sealed class SpringvaleFont : WellspringMirror
{
}
