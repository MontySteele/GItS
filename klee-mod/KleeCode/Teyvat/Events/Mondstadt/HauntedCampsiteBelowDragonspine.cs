...
/// <summary>
/// The Haunted Campsite Below Dragonspine -- UnrestSite, dressed for Mondstadt.
///
...
/// base event's clauses are in <see cref="UnrestSiteMirror"/>, written
/// once and shared by every nation that dresses this event; this class
/// is a NAME. `ModelDb.GetEntry` slugifies it into
/// `HAUNTED_CAMPSITE_BELOW_DRAGONSPINE`, `EventModel.Title` and `InitialDescription`
...
/// </summary>
public sealed class HauntedCampsiteBelowDragonspine : UnrestSiteMirror
{
}
