...
/// <summary>
/// The Guest in the Hull -- Symbiote, dressed for Fontaine.
///
...
/// `GUEST_IN_THE_HULL`, `EventModel.Title` and `InitialDescription`
...
/// </summary>
public sealed class GuestInTheHull : SymbioteMirror
{
}
