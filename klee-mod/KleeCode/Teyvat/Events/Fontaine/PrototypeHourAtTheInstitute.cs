...
/// <summary>
/// Prototype Hour at the Institute -- TinkerTime, dressed for Fontaine.
///
...
/// base event's clauses are in <see cref="TinkerTimeMirror"/>, written
/// once and shared by every nation that dresses this event; this class
/// is a NAME. `ModelDb.GetEntry` slugifies it into
/// `PROTOTYPE_HOUR_AT_THE_INSTITUTE`, `EventModel.Title` and `InitialDescription`
...
/// </summary>
public sealed class PrototypeHourAtTheInstitute : TinkerTimeMirror
{
}
