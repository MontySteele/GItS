...
/// <summary>
/// Pressure Trial at the Institute -- BattlewornDummy, dressed for Fontaine.
///
...
/// base event's clauses are in <see cref="BattlewornDummyMirror"/>, written
/// once and shared by every nation that dresses this event; this class
/// is a NAME. `ModelDb.GetEntry` slugifies it into
/// `PRESSURE_TRIAL_AT_THE_INSTITUTE`, `EventModel.Title` and `InitialDescription`
...
/// </summary>
public sealed class PressureTrialAtTheInstitute : BattlewornDummyMirror
{
}
