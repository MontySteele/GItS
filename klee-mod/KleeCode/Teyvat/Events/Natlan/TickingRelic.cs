...
/// <summary>
/// The Ticking Relic -- InfestedAutomaton, dressed for Natlan.
///
...
/// `TICKING_RELIC`, `EventModel.Title` and `InitialDescription`
...
/// </summary>
public sealed class TickingRelic : InfestedAutomatonMirror
{
}
