...
/// <summary>
/// The Springs' Rooted Thing -- SpiritGrafter, dressed for Natlan.
///
...
/// `SPRINGS_ROOTED_THING`, `EventModel.Title` and `InitialDescription`
...
/// </summary>
public sealed class SpringsRootedThing : SpiritGrafterMirror
{
}
