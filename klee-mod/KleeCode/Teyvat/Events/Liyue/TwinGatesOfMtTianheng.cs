...
/// <summary>
/// The Twin Gates of Mt. Tianheng -- DoorsOfLightAndDark, dressed for Liyue.
///
...
/// base event's clauses are in <see cref="DoorsOfLightAndDarkMirror"/>, written
/// once and shared by every nation that dresses this event; this class
/// is a NAME. `ModelDb.GetEntry` slugifies it into
/// `TWIN_GATES_OF_MT_TIANHENG`, `EventModel.Title` and `InitialDescription`
...
/// </summary>
public sealed class TwinGatesOfMtTianheng : DoorsOfLightAndDarkMirror
{
}
