...
/// <summary>
/// The Qingce Larder -- RoomFullOfCheese, dressed for Liyue.
///
...
/// `QINGCE_LARDER`, `EventModel.Title` and `InitialDescription`
...
/// </summary>
public sealed class QingceLarder : RoomFullOfCheeseMirror
{
}
