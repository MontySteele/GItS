...
/// <summary>
/// The Flooded Ledger-Room -- WaterloggedScriptorium, dressed for Liyue.
///
...
/// base event's clauses are in <see cref="WaterloggedScriptoriumMirror"/>, written
/// once and shared by every nation that dresses this event; this class
/// is a NAME. `ModelDb.GetEntry` slugifies it into
/// `FLOODED_LEDGER_ROOM`, `EventModel.Title` and `InitialDescription`
...
/// </summary>
public sealed class FloodedLedgerRoom : WaterloggedScriptoriumMirror
{
}
