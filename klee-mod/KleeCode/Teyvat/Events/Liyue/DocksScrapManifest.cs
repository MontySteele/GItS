...
/// <summary>
/// The Docks Scrap Manifest -- TrashHeap, dressed for Liyue.
///
...
/// base event's clauses are in <see cref="TrashHeapMirror"/>, written
/// once and shared by every nation that dresses this event; this class
/// is a NAME. `ModelDb.GetEntry` slugifies it into
/// `DOCKS_SCRAP_MANIFEST`, `EventModel.Title` and `InitialDescription`
...
/// </summary>
public sealed class DocksScrapManifest : TrashHeapMirror
{
}
