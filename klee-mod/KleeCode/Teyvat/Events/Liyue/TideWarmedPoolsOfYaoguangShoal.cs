...
/// <summary>
/// The Tide-Warmed Pools of Yaoguang Shoal -- AbyssalBaths, dressed for Liyue.
///
...
/// base event's clauses are in <see cref="AbyssalBathsMirror"/>, written
/// once and shared by every nation that dresses this event; this class
/// is a NAME. `ModelDb.GetEntry` slugifies it into
/// `TIDE_WARMED_POOLS_OF_YAOGUANG_SHOAL`, `EventModel.Title` and `InitialDescription`
...
/// </summary>
public sealed class TideWarmedPoolsOfYaoguangShoal : AbyssalBathsMirror
{
}
