...
/// <summary>
/// The Whirlpool Below Yaoguang Shoal -- SpiralingWhirlpool, dressed for Liyue.
///
...
/// base event's clauses are in <see cref="SpiralingWhirlpoolMirror"/>, written
/// once and shared by every nation that dresses this event; this class
/// is a NAME. `ModelDb.GetEntry` slugifies it into
/// `WHIRLPOOL_BELOW_YAOGUANG_SHOAL`, `EventModel.Title` and `InitialDescription`
...
/// </summary>
public sealed class WhirlpoolBelowYaoguangShoal : SpiralingWhirlpoolMirror
{
}
