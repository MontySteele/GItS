...
/// <summary>
/// The Northland Bank's Drowned Vault -- SunkenTreasury, dressed for Liyue.
///
...
/// base event's clauses are in <see cref="SunkenTreasuryMirror"/>, written
/// once and shared by every nation that dresses this event; this class
/// is a NAME. `ModelDb.GetEntry` slugifies it into
/// `NORTHLAND_BANKS_DROWNED_VAULT`, `EventModel.Title` and `InitialDescription`
...
/// </summary>
public sealed class NorthlandBanksDrownedVault : SunkenTreasuryMirror
{
}
