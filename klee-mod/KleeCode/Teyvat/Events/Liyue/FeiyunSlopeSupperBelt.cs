...
/// <summary>
/// The Feiyun Slope Supper Belt -- EndlessConveyor, dressed for Liyue.
///
...
/// base event's clauses are in <see cref="EndlessConveyorMirror"/>, written
/// once and shared by every nation that dresses this event; this class
/// is a NAME. `ModelDb.GetEntry` slugifies it into
/// `FEIYUN_SLOPE_SUPPER_BELT`, `EventModel.Title` and `InitialDescription`
...
/// </summary>
public sealed class FeiyunSlopeSupperBelt : EndlessConveyorMirror
{
}
