...
CASES: list[tuple[list[str], bool, str]] = [
    ...
    (["review/records/ci-fast-lane-2026-08-29.md"], True, "a review packet"),
    (["README.md"], True, "a repo-root readme"),
    (["CLAUDE.md", "AGENTS.md"], True, "the two routing files"),
    (["docs/current/STATE.md", "review/ruled/payoff-census-2026-08-08.md",
      "CLAUDE.md"], True,
    ...
    (["review/qa/furina-e4-review-prompt.txt"], False, "a review/qa txt"),
    (["review/qa/funnel-bench-1-round-summary.json"], False, "a review/qa json"),
    (["docs/current/STATE.md", "review/qa/funnel-bench-1-round-summary.json"], False,
