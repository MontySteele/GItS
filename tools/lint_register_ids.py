...
CEILINGS: dict[str, int] = {
    ...
    "EB": 278,   # EB-239/240 minted 2026-08-30 by KLEESPARK-BT2 (Klee Sparks
...
OPEN_IDS: dict[str, frozenset[int]] = {
    "EB": frozenset({
        ...
        256,
        257,
        259, 260, 261, 262, 263, 264, 265, 266, 267, 268, 269, 270, 271, 272, 273, 274, 275, 276, 277, 278,  # Klee/Kokomi overhaul rounds, 2026-09-01/02
    }),
