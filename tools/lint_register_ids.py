...
CEILINGS: dict[str, int] = {
    ...
    # (`klee-overhaul-round-3-runs-2026-09-02`), which is where their rows are.
    # The ceiling is a floor on "ever issued" and only moves forward, so it
    # carries them here even though this branch defines none of them -- the
    # alternative is two branches each thinking 285 is free.
