...
round of 3 board(s) in R221 B's pre-registered order; seat spot-check every 1; first set = 3; lanes = 1
   1  FIRST  SEAT  lane0  klee-sparks-bt2-t02   slots=C1  closeness=0.019
   2  FIRST  SEAT  lane0  klee-sparks-bt2-t01   slots=C1  closeness=0.031
   3  FIRST  SEAT  lane0  klee-sparks-bt2-t03   slots=C2  closeness=0.117
preflights: every board passes face-defect and assumption checks
SLOT OK   C1: threshold 2, ceiling 2 of 3 board(s)  [klee-sparks-bt2-t02, klee-sparks-bt2-t01]
SLOT OK   C2: threshold 1, ceiling 1 of 3 board(s)  [klee-sparks-bt2-t03]
