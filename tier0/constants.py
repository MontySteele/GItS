...
FANFARE_DECAY_FRACTION = 0.0  # PROPORTIONAL decay, as a fraction of the
                              # meter, applied INSTEAD of the flat amount
                              # when > 0. 0.0 = use FANFARE_DECAY_PER_TURN.
                              # Taken off the shelf 2026-07-24 at [USER]
                              # request to sweep the proportional shape the
                              # plan had ruled against on tooltip grounds.
