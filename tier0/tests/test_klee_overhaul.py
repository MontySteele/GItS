...
def test_the_pool_is_the_slices_rows_and_the_passes_that_followed():
    ...
    FIFTY-ONE SINCE POOL PASS TWO (2026-09-08, `EB-724`), and the SIX that
    ...
    # POOL PASS TWO's six (`EB-724`), by name and for the same reason.
...
def test_the_pool_keeps_the_packets_rarity_split(overhaul):
    ...
    POOL PASS TWO (`EB-724`) adds ONE Common (Bottomless Bag), FOUR Uncommons
...
# ---------------------------------------------------------------------------
# 8. POOL PASS TWO (`EB-724`) -- one case per row, both new ops and both new
