...
def test_a_replay_does_not_double_klees_mint(manual):
    ...
    # `EB-663` widened the gate to "or C.KLEE_OVERHAUL" -- under the arm a
    # marked Klee card pays and is no Companion -- so the pin is on the
    # `replay_index == 0` half, which is the half this test is about.
