...
#: POOL PASS TWO's rider (`EB-732`, Return to Sender): "This turn, damage this
...
#: POOL PASS TWO's Rare Power (`EB-732`, Blazing Delight): "At the start of
...
def turn_start_late(state: CombatState) -> None:
    ...
    # RETURN TO SENDER's HOUSEKEEPING (`EB-732`), and it is the whole of what
    ...
    # BLAZING DELIGHT (`EB-732`): "At the start of your turn, gain 1 Energy and
    # draw 1 card."
    #
...
# ---------------------------------------------------------------------------
# POOL PASS TWO's TWO CARD VERBS (`EB-732`) -- the piles, not the pile
# ---------------------------------------------------------------------------
...
def block_absorbed(state: CombatState, enemy: Enemy, blocked: int,
    ...
    """Return to Sender (`EB-732`): "This turn, damage this Block absorbs is
