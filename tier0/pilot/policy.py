...
_ENGINE_LIVE_PREDICATES = frozenset({
    ...
    # WITHDRAWN 2026-09-08 with pool pass seven; the predicate and this line
    # stay, because the hole below is what they are evidence of.
    #
    ...
    # (`docs/notes/prototype-surface-provenance.md`, "Passes six and seven
    # withdrawn") was taken with this line in, and `EB-712` is the row it
    # opened.
    #
